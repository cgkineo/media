...
this.floorPrecision)},isAtEnd:function(){return 1>=Math.abs(Math.floor(this.ui.source.currentTime*this.floorPrecision)-Math.floor(this.ui.source.duration*this.floorPrecision))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.Resize=MediaUI.Output.extend({ui:null,$els:null,$elsinner:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"resize");this.$elsinners=a.$all().filterByAttribute(a.options.outputattribute,"resizeinner");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{resize:this.onResize}))},onResize$bind:function(a){var b=this.getUIDimensions(),c=new Media.Class.Dimensions(this.ui.el.offsetParent||window),d=b[this.ui.fullscreen.isActive?
"fullscreen":"normal"];"auto"===d.height.unit&&"auto"===d.width.unit&&(d.height.value="contain",d.height.unit="contain",d.width.value="contain",d.width.unit="contain");"cover"===d.height.value&&(d.height.value="fill",d.height.unit="fill",d.width.value="fill",d.width.unit="fill");this.$els.forEach(function(a){var b=this.getStyles(a,this.ui.source,c,d),e;for(e in b)rafer.set(a.style,e,b[e])}.bind(this));b=!!elements(this.ui.source).path().find(function(a){return a===this.ui.el}.bind(this));var e=new Media.Class.Dimensions((b?
this.ui.el.offsetParent:this.ui.source.offsetParent)||window),f=a[this.ui.fullscreen.isActive?"fullscreen":"normal"];if(b)switch(d.height.value){case "contain":a="auto"===f.height.unit&&"auto"===f.width.unit;if("fill"===f.height.value||"cover"===f.height.value||a)f.height.value="contain",f.height.unit="contain",f.width.value="contain",f.width.unit="contain";break;case "fill":if(a="auto"===f.height.unit&&"auto"===f.width.unit)f.height.value="cover",f.height.unit="cover",f.width.value="cover",f.width.unit=
"cover";break;case "retain":f.height.value="retain",f.height.unit="retain",f.width.value="retain",f.width.unit="retain"}this.$elsinners.forEach(function(a){var b=this.getStyles(a,this.ui.source,e,f,{usePxValues:!1,transform:Media.device.isIE11?"scale(1.02)":""}),c;for(c in b)rafer.set(a.style,c,b[c])}.bind(this))},getStyles:function(a,b,c,d,e){e=e||{};e.transform=e.transform||"";a={"object-fit":"fill"};switch(d.width.unit){case "contain":d.ratio<=c.ratio?(a.height=e.usePxValues?makeUnit(c.height.value,
c.height.unit):"100%",a.width=makeUnit(c.height.value*d.ratio,c.height.unit)):(a.width=e.usePxValues?makeUnit(c.width.value,c.width.unit):"100%",a.height=makeUnit(c.width.value/d.ratio,c.width.unit));break;case "cover":d.ratio<=c.ratio?(a.width=e.usePxValues?makeUnit(c.width.value,c.width.unit):"100%",a.height=makeUnit(c.width.value/d.ratio,c.width.unit)):(a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%",a.width=makeUnit(c.height.value*d.ratio,c.height.unit));break;case "retain":var f=
clamp(0,c.height.value,b.videoHeight||b.originalHeight||b.height);b=clamp(0,c.width.value,b.videoWidth||b.originalWidth||b.width);d.ratio<=c.ratio?(a.height=makeUnit(f,c.height.unit),a.width=makeUnit(f*d.ratio,c.height.unit)):(a.width=makeUnit(b,c.width.unit),a.height=makeUnit(b/d.ratio,c.width.unit));break;case "fill":a.width=e.usePxValues?makeUnit(c.width.value,c.width.unit):"100%";a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%";break;case "none":a.height="";a.width="";break;
default:"auto"!==d.width.unit&&(a.width=makeUnit(d.width.value,d.width.unit)),"auto"!==d.height.unit&&(a.height=makeUnit(d.height.value,d.height.unit)),"auto"===d.width.unit&&(a.width=makeUnit(c.height.value*d.ratio,"px")),"auto"===d.height.unit&&(a.height=makeUnit(c.width.value/d.ratio,"px"))}var g=!1;c=!1;b=["0","0"];f=["","","",""];switch(d.x.keyword){case "center":c=g=!0;f[3]="50%";b[0]="-50%";break;case "left":g=!0;f[3]=d.x.value;break;case "right":g=!0,f[1]=d.x.value}switch(d.y.keyword){case "center":c=
g=!0;f[0]="50%";b[1]="-50%";break;case "top":g=!0;f[0]=d.y.value;break;case "bottom":g=!0,f[2]=d.y.value}a.position=g?"absolute":"";d=[e.transform];c&&d.unshift("translate("+b.join(",")+")");a.transform=d.length?d.join(" "):"";a.top=f[0];a.right=f[1];a.bottom=f[2];a.left=f[3];return a},getUIDimensions:function(){var a=this.ui.options;return{fullscreen:new Media.Class.Dimensions(a.uifullscreensize,a.uifullscreenratio,a.uifullscreenposition),normal:new Media.Class.Dimensions(a.uisize,a.uiratio,a.uiposition)}},
destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.el=this.ui=null}});Media.DefaultOptions.add({uisize:function(){return this.mediasize},uiratio:function(){return this.mediaratio},uiposition:"none none",uifullscreensize:function(){return this.uisize},uifullscreenratio:function(){return this.uiratio},uifullscreenposition:function(){return this.uiposition}}); return exports;}));
