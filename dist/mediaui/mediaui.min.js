...
r?1:0;if(1<t)throw"Cannot have two types in one definition.";t+=v?1:0;t+=u?1:0;t+=n?1:0;q?(m=!0,u=!1,q=c(k,b[h])):q=b[h];r=e[k]=e[k]||{value:q};m&&(r.get=q);p&&(r.set=q);v&&(r.enumerable=!0);u&&(r.writable=!0);n&&(r.configurable=!0);r.value&&(r.get||r.set)&&delete r.value;delete b[h];delete a[k]}}}if(!Object.keys(e).length)return a;Object.defineProperties(a,e);return a};var EventsInitialize=function(a){a.hasOwnProperty("events")&&a.events&&a.trigger||(a.hasOwnProperty("events")&&a.events||Object.defineProperty(a,"events",{value:new EventsRegistry,enumerable:!1,writable:!0}),a.trigger||Object.defineProperty(a,"trigger",{value:Events.trigger,enumerable:!1,writable:!0}))},EventsArgumentsNotation=function(a,b,c,d,e){if(a instanceof Object){c=c||e;for(var f in a)for(var g=f.split(" "),l=0,h=g.length;l<h;l++){var k=g[l];d.call(e,k,a[f],c)}}else if("string"===typeof a)for(c=
