...
c=new Media.Class.Dimensions(this.ui.el.offsetParent||window);b=this.getStyles(a,this.ui.source,c,b[this.ui.fullscreen.isActive?"fullscreen":"normal"]);for(var d in b)rafer.set(a.style,d,b[d])}.bind(this))},resizeinner:function(){this.$elsinners.forEach(function(a){var b=elements(this.ui.source).path().find(function(a){return a===this.ui.el}.bind(this))?this.ui.el.offsetParent:this.ui.source.offsetParent;b=new Media.Class.Dimensions(b||window);b=this.getStyles(a,this.ui.source,b,event[this.ui.fullscreen.isActive?
"fullscreen":"normal"],{transform:Media.device.isIE11?"scale(1.02)":""});for(var c in b)rafer.set(a.style,c,b[c])}.bind(this))},getStyles:function(a,b,c,d,e){e=e||{};e.transform=e.transform||"";a={"object-fit":"fill"};switch(d.width.unit){case "contain":d.ratio<=c.ratio?(a.height="100%",a.width=makeUnit(c.height.value*d.ratio,c.height.unit)):(a.width="100%",a.height=makeUnit(c.width.value/d.ratio,c.width.unit));break;case "cover":d.ratio<=c.ratio?(a.width="100%",a.height=makeUnit(c.width.value/d.ratio,
c.width.unit)):(a.height="100%",a.width=makeUnit(c.height.value*d.ratio,c.height.unit));break;case "retain":var f=clamp(0,c.height.value,b.videoHeight||b.originalHeight||b.height);b=clamp(0,c.width.value,b.videoWidth||b.originalWidth||b.width);d.ratio<=c.ratio?(a.height=makeUnit(f,c.height.unit),a.width=makeUnit(f*d.ratio,c.height.unit)):(a.width=makeUnit(b,c.width.unit),a.height=makeUnit(b/d.ratio,c.width.unit));break;case "fill":a.height="100%";a.width="100%";break;case "none":a.height="";a.width=
"";break;default:"auto"!==d.width.unit&&(a.width=makeUnit(d.width.value,d.width.unit)),"auto"!==d.height.unit&&(a.height=makeUnit(d.height.value,d.height.unit)),"auto"===d.width.unit&&(a.width=makeUnit(c.height.value*d.ratio,"px")),"auto"===d.height.unit&&(a.height=makeUnit(c.width.value/d.ratio,"px"))}var g=!1;c=!1;b=["0","0"];f=["","","",""];switch(d.x.keyword){case "center":c=g=!0;f[3]="50%";b[0]="-50%";break;case "left":g=!0;f[3]=d.x.value;break;case "right":g=!0,f[1]=d.x.value}switch(d.y.keyword){case "center":c=
