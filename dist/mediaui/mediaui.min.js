...
case 4:b=c}switch(b[0]){case "auto":switch(b[2]){case "auto":case "top":case "bottom":b[0]="left";break;case "left":case "right":b[0]="top"}}switch(b[2]){case "auto":switch(b[0]){case "auto":case "top":case "bottom":b[2]="left";break;case "left":case "right":b[2]="top"}}switch(b[2]){case "left":case "right":a=b[0],c=b[1],b[0]=b[2],b[1]=b[3],b[2]=a,b[3]=c}this.x={keyword:b[0],value:b[1]};this.y={keyword:b[2],value:b[3]}},position$get$enum:function(){return this._position}});Media.Class.Ended=Media.Class.extend({floorPrecision:10,constructor:function(){this.listenTo(Media,{created:this.onCreated,play:this.onPlay,"timeupdate pause":this.onUpdate,ended:this.onEnded})},onCreated:function(a){a.defineProperties({hasFiredEnded$write:!1})},onPlay:function(a){this.isEnded(a)&&a.hasFiredEnded&&(a.el.currentTime=0);a.hasFiredEnded=!1},onUpdate:function(a){!this.isEnded(a)||a.isAtEnd?a.hasFiredEnded=!1:setTimeout(function(){a.el&&!a.hasFiredEnded&&this.isEnded(a)&&(a.el.currentTime=
a.el.duration,a.el.paused||a.el.pause(),a.dispatchEvent("ended"))}.bind(this),150)},onEnded:function(a){a.hasFiredEnded=!0},isEnded:function(a){return 1>=Math.abs(Math.floor(a.el.currentTime*this.floorPrecision)-Math.floor(a.el.duration*this.floorPrecision))}});Media.defineProperties({ended:new Media.Class.Ended});Media.Class.PauseOnOtherPlay=Media.Class.extend({constructor:function(){this.listenTo(Media,{created:this.onCreated,play:this.onPlay})},onCreated:function(a){a.defineProperties({pauseonotherplay$enum$write:a.options.pauseonotherplay})},onPlay:function(a){a=0;for(var b=Media.players;a<b;a++){var c=Media.players[a];c.pauseonotherplay&&c.el.pause()}}});Media.defineProperties({pauseonotherplay:new Media.Class.PauseOnOtherPlay});Media.DefaultOptions.add({pauseonotherplay:!1});Media.Class.Players=Media.Class.List.extend({constructor:function(){List.apply(this,arguments)},findById:function(a){for(var b=0,c=this.length;b<c;b++){var d=this[b];if(d.el&&d.el.id===a)return d}return null},findByElement:function(a){for(var b=0,c=this.length;b<c;b++){var d=this[b];if(d.el&&d.el.id===a)return d}return null}});Media.defineProperties({players$enum$write:new Media.Class.Players});Media.Class.Resize=Media.Class.extend({constructor:function(a){this.listenTo(Media,{created:this.onCreated,resize:this.onResize});this.addEventListeners()},addEventListeners$write:function(){window.removeEventListener("resize",this.onWindowResize);window.addEventListener("resize",this.onWindowResize);document.addEventListener("fullscreenchange",this.onFullScreenChanged)},onCreated:function(a){this.triggerMediaResize(a)},onFullScreenChanged$write$bind:function(){delay(this.resizeAllPlayers,1)},onResize:function(a,
b){b.fake||this.resizeAllPlayers()},onWindowResize$write$bind:function(){this.resizeAllPlayers()},resizeAllPlayers$bind:function(){for(var a=0,b=Media.players.length;a<b;a++)this.triggerMediaResize(Media.players[a])},triggerMediaResize:function(a){a.dispatchEvent("resize",this.getDimensions(a));a.dispatchEvent("postresize",this.getDimensions(a))},getDimensions:function(a){a=a.options;return{fullscreen:new Media.Class.Dimensions(a.mediafullscreensize,a.mediafullscreenratio,a.mediafullscreenposition),
normal:new Media.Class.Dimensions(a.mediasize,a.mediaratio,a.mediaposition)}},removeEventListeners$write:function(){window.removeEventListener("resize",this.onWindowResize);document.removeEventListener("fullscreenchange",this.onFullScreenChanged)}});Media.defineProperties({resize$write:new Media.Class.Resize});Media.DOMEvents.add(["resize","postresize"]);
...
document.exitFullscreen():this.ui.source.requestFullscreen():document.fullscreenElement?document.exitFullscreen():this.ui.el.requestFullscreen()},onDoubleTap$bind:function(){if(!Media.device.wasUsingTouchRecently)this.onClick()},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.$els.off("click",this.onClick);this.ui=null}});Media.DefaultOptions.add({iosnativefullscreen:!0,usefullwindow:!1});MediaUI.Input.ToggleMute=MediaUI.Input.extend({ui:null,$els:null,constructor:function(a){MediaUI.Input.apply(this,arguments);this.ui=a;this.$els=this.ui.$all().filterByAttribute(this.ui.options.inputattribute,"togglemute");this.$els.on({click:this.onClick})},onClick$bind:function(){this.ui.source.muted=!this.ui.source.muted},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.$els.off("click",this.onClick);this.ui=null}});MediaUI.Input.TogglePlayPause=MediaUI.Input.extend({ui:null,$els:null,constructor:function(a){MediaUI.Input.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.inputattribute,"toggleplaypause");this.$els.length&&(this.ui=a,this.$els.on({click:this.onClick}),this.listenTo(this.ui,{tap:this.onTap}))},onClick$bind:function(a){a.stopPropagation();elements(a.target).isHidden()||(this.ui.trigger("stoptap"),this.toggle())},onTap$bind:function(a){if(this.ui.options.uitaptoplaypause){a=elements(a.target);
var b=a.path().filterByAttribute(this.ui.options.inputattribute,"toggleplaypausenotouch");a.isHidden()||!b.length||Media.device.wasUsingTouchRecently||this.toggle()}},toggle:function(){this.ui.source.paused?this.ui.source.play():this.ui.source.pause()},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.$els.off("click",this.onClick);this.ui=null}});Media.DefaultOptions.add({uitaptoplaypause:!0});MediaUI.Output.BufferedWidth=MediaUI.Output.extend({floorPrecision:10,ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"bufferedwidth");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"timeupdate postresize ended":this.onTimeUpdate,destroyed:this.destroy}),this.onTimeUpdate())},onTimeUpdate:function(a){a&&"timeupdate"===a.type&&!a.medium||this.update()},update:function(){if(this.$els.length){var a=
...
"innerHTML","")})},onCueEnter$bind:function(a){this.$els.forEach(function(b){rafer.call(b,"appendChild",a.cue.getCueAsHTML())})},onCueExit$bind:function(a){this.$els.forEach(function(b){b=b.querySelectorAll("#"+a.cue.id);for(var c=0,d=b.length;c<d;c++){var e=elements(b[c]);rafer.call(e,"remove")}})},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.CaptionsAria=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"captionsaria");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{texttrackchange:this.onUpdate}),this.onUpdate())},onUpdate:function(a){this.$els.length&&MediaUI.languages.load(this.ui.options,function(a){var b=this.ui.captions.isActive;a=b?replace("${Captions}",a.hash):replace("${captions off}",a.hash);
rafer.call(this.$els,"attr","aria-label",a);rafer.call(this.$els,"attr","aria-pressed",b)}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.CaptionsState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"captionsstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{texttrackchange:this.onTextTrackChange}),this.onTextTrackChange())},onTextTrackChange$bind:function(a){rafer.call(this.$els,"toggleClass",this.ui.options.classprefix+"captionsstate-active",this.ui.captions.isActive)},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,
arguments);this.$els=this.ui=null}});MediaUI.Output.ControlBarOrder=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"controlbarorder");this.$els.length&&(this.ui=a,this.reorder())},reorder:function(){var a={};(this.ui.options.uicontrolbarorder||["playpause","rail","mute","captions","fullscreen"]).forEach(function(b,c){a[b]=c+1});this.$els.forEach(function(b){var c=elements(b);b=c.children();var d=b.map(function(b){var c=
b.getAttribute(this.ui.options.controlbarorderattribute);return{el:b,order:c&&a[c]||null}}.bind(this));d.sort(function(a,b){return null===a.order&&null===b.order?0:null===a.order?-1:null===b.order?1:a.order-b.order}.bind(this));b.remove();d.forEach(function(a){a.order&&c.append(a.el)})}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});
Media.DefaultOptions.add({controlbarorderattribute:"data-media-controlbarorder",uicontrolbarorder:["playpause","rail","mute","captions","fullscreen"]});MediaUI.Output.ControlBarState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$el=a.$el;this.ui=a;this.$el.on({focus:onFocus,blur:onBlur});this.onTextTrackChange()},onTextTrackChange$bind:function(a){rafer.call(this.$els,"toggleClass",this.ui.options.classprefix+"captionsstate-active",this.ui.captions.isActive)},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.CurrentTimeAria=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"currenttimearia");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{timeupdate:this.onUpdate}),this.onUpdate())},onUpdate:function(a){(!a||a.fake&&a.medium)&&this.$els.length&&MediaUI.languages.load(this.ui.options,function(a){var b=parseInt(this.ui.source.currentTime),d=parseInt(this.ui.source.duration||
0);a=a.hash["Progress Bar"]+" "+a.hash["progress bar timing: currentTime={1} duration={2}"].replace("{1}",b).replace("{2}",d);rafer.call(this.$els,"attr","role","slider");rafer.call(this.$els,"attr","aria-valuemax",d);rafer.call(this.$els,"attr","aria-valuemin",0);rafer.call(this.$els,"attr","aria-valuenow",b);rafer.call(this.$els,"attr","aria-label",a)}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.CurrentTimeWidth=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"currenttimewidth");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"timeupdate postresize ended":this.onTimeUpdate,destroyed:this.destroy}),this.onTimeUpdate())},onTimeUpdate:function(a){a&&"timeupdate"===a.type&&!a.medium||this.update()},update:function(){if(this.$els.length)for(var a=this.ui.source.currentTime/
...
this.floorPrecision)},isAtEnd:function(){return 1>=Math.abs(Math.floor(this.ui.source.currentTime*this.floorPrecision)-Math.floor(this.ui.source.duration*this.floorPrecision))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.Poster=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"poster");this.$els.length&&(this.ui=a,this.addImage())},addImage:function(){var a=this.ui.source.getAttribute("poster");this.$els.forEach(function(b){switch(b.nodeName){case "IMG":b.src=a;break;default:b.style.backgroundImage="url("+a+")"}}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,
arguments);this.$els=this.ui=null}});MediaUI.Output.Resize=MediaUI.Output.extend({ui:null,$els:null,$elsinner:null,initial:!0,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"resize");this.$elsinners=a.$all().filterByAttribute(a.options.outputattribute,"resizeinner");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{resize:this.onResize}),this.listenTo(this.ui.options,"change",this.onOptionsChange))},onOptionsChange:function(a,b,c){switch(a){case "mediasize":case "mediaposition":case "mediaratio":case "mediafullscreensize":case "mediafullscreenposition":case "mediafullscreenratio":case "uisize":case "uiposition":case "uiratio":case "uifullscreensize":case "uifullscreenposition":case "uifullscreenratio":this.onResize(Media.resize.getDimensions(this.ui.media))}},
...
makeUnit(c.width.value,c.width.unit):"100%",a.height=makeUnit(c.width.value/d.ratio,c.width.unit)):(a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%",a.width=makeUnit(c.height.value*d.ratio,c.height.unit));break;case "retain":var f=clamp(0,c.height.value,b.videoHeight||b.originalHeight||b.height);b=clamp(0,c.width.value,b.videoWidth||b.originalWidth||b.width);d.ratio<=c.ratio?(a.height=makeUnit(f,c.height.unit),a.width=makeUnit(f*d.ratio,c.height.unit)):(a.width=makeUnit(b,c.width.unit),
a.height=makeUnit(b/d.ratio,c.width.unit));break;case "fill":a.width=e.usePxValues?makeUnit(c.width.value,c.width.unit):"100%";a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%";break;case "none":a.height="";a.width="";break;default:"auto"!==d.width.unit&&(a.width=makeUnit(d.width.value,d.width.unit)),"auto"!==d.height.unit&&(a.height=makeUnit(d.height.value,d.height.unit)),"auto"===d.width.unit&&(a.width=makeUnit(c.height.value*d.ratio,"px")),"auto"===d.height.unit&&(a.height=makeUnit(c.width.value/
d.ratio,"px"))}var g=!1;c=!1;b=["0","0"];f=["","","",""];switch(d.x.keyword){case "center":c=g=!0;f[3]="50%";b[0]="-50%";break;case "left":g=!0;f[3]=d.x.value;break;case "right":g=!0,f[1]=d.x.value}switch(d.y.keyword){case "center":c=g=!0;f[0]="50%";b[1]="-50%";break;case "top":g=!0;f[0]=d.y.value;break;case "bottom":g=!0,f[2]=d.y.value}a.position=g?"absolute":"";d=[e.transform];c&&d.unshift("translate("+b.join(",")+")");a.transform=d.length?d.join(" "):"";a.top=f[0];a.right=f[1];a.bottom=f[2];a.left=
f[3];return a},getUIDimensions:function(){var a=this.ui.options;return{fullscreen:new Media.Class.Dimensions(a.uifullscreensize,a.uifullscreenratio,a.uifullscreenposition),normal:new Media.Class.Dimensions(a.uisize,a.uiratio,a.uiposition)}},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.el=this.ui=null}});
