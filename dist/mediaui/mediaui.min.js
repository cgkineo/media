...
f;e++){for(var g=a[e],l=!1,h=0,k=d.length;h<k;h++)d[h]===g&&(l=!0);!l&&b?d.add(g):l&&!b&&d.remove(g)}c.classList.length||elements(c).removeAttribute("class")});return this},html:function(a){if(void 0===a)return this[0]&&this[0].innerHTML;this.forEach(function(b){b.innerHTML=a})},dispatchEvent:function(a,b){var c=this[0];b=defaults(b,{bubbles:!1,cancelable:!0});if(!Elements._ie11)try{var d=new Event(a,b);extend(d,b);c.dispatchEvent(d);return this}catch(e){Elements._ie11=!0}if(Elements._ie11)return d=
document.createEvent("Event"),d.initEvent(a,b.bubbles,b.cancelable),extend(d,b),c.dispatchEvent(d),this}}),elements=function(a,b){return new Elements(a,b)};extend(elements,Elements);var Rafer=Class.extend({deferred:null,requests:null,isWaiting:!1,mode:"ram",ramLimit:50,currentDeferredLength:0,currentRequestsLength:0,constructor:function(){this.defineProperties({deferred$write:Array(100),requests$write:Array(100),currentDeferredLength$write:0,currentRequestsLength$write:0,isWaiting$write:!1})},resizeDeferred$write:function(){this.deferred.length*=2},resizeRequests$write:function(){this.requests.length*=2},set:function(a,b,c){this.isWaiting||this.request(this.dummy);this.currentDeferredLength===
