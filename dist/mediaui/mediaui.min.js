...
d+"\\}","gi");a=a.replace(e,b[d])}c.clean&&(a=a.replace(/\$\{[^\}]+\}/g,""));return a};var properties=function(a,b){var c=function(a,b){return function(){return this["_"+a]=this["_"+a]||b.bind(this)}},d=!!b;b=b||a;for(var e={},f=Object.getOwnPropertyNames(b),g=0,l=f.length;g<l;g++){var k=f[g],h=k.indexOf("$");if(-1!==h||d){if(-1===h){var m="";h=k}else m=k.slice(h),h=k.slice(0,h);if(h){var n=m.split("$"),q=includes(n,"bind");m=includes(n,"get");var p=includes(n,"set"),r=includes(n,"value"),v=includes(n,"enum"),u=includes(n,"write");n=includes(n,"config");var t=0;t+=m?1:0;t+=p?1:0;t+=
r?1:0;if(1<t)throw"Cannot have two types in one definition.";t+=v?1:0;t+=u?1:0;t+=n?1:0;q?(m=!0,u=!1,q=c(h,b[k])):q=b[k];r=e[h]=e[h]||{value:q};m&&(r.get=q);p&&(r.set=q);v&&(r.enumerable=!0);u&&(r.writable=!0);n&&(r.configurable=!0);r.value&&(r.get||r.set)&&delete r.value;delete b[k];delete a[h]}}}if(!Object.keys(e).length)return a;Object.defineProperties(a,e);return a};var EventsInitialize=function(a){a.hasOwnProperty("events")&&a.events&&a.trigger||(a.hasOwnProperty("events")&&a.events||Object.defineProperty(a,"events",{value:new EventsRegistry,enumerable:!1,writable:!0}),a.trigger||Object.defineProperty(a,"trigger",{value:Events.trigger,enumerable:!1,writable:!0}))},EventsArgumentsNotation=function(a,b,c,d,e){if(a instanceof Object){c=c||e;for(var f in a)for(var g=f.split(" "),l=0,k=g.length;l<k;l++){var h=g[l];d.call(e,h,a[f],c)}}else if("string"===typeof a)for(c=
c||e,g=a.split(" "),l=0,k=g.length;l<k;l++)h=g[l],d.call(e,h,b,c);else if(void 0===a&&void 0===b&&void 0===c)return d.call(e,null,null,null)},EventsRegistry=function(){};EventsRegistry.prototype=[];var EventRegister=function(a){if(a.name){if(!a.callback)throw"Cannot find callback";EventsInitialize(a.from);EventsInitialize(a.to);this.from=a.from;this.to=a.to;this.context=a.context;this.name=a.name;this.callback=a.callback;this.once=a.once;this.from.events.push(this);this.from!==this.to&&this.to.events.push(this)}};
...
"onmozfullscreenchange","onmsfullscreenchange"],onfullscreenerror:["onwebkitfullscreenerror","onmozfullscreenerror","onmsfullscreenerror"],fullscreenchange:["webkitfullscreenchange","mozfullscreenchange","msfullscreenchange"],fullscreenerror:["webkitfullscreenerror","mozfullscreenerror","msfullscreenerror"]},g=!1,l=!0,k=!0,h=function(a,b,c){if(void 0!==a[b])e[b]=b;else{c=0;for(var d=f[b].length;c<d;c++){var g=f[b][c];if(void 0!==a[g]){l=!1;e[b]=g;return}}k=l=!1;e[b]=null}},m=!1,n=null,q=!1,p={fullscreenElement:!1,
fullscreenEnabled:!1,exitFullscreen:!1,requestFullscreen:!1,onfullscreenchange:!1,onfullscreenerror:!1};document.addEventListener("fullscreenchange",function(a){document.fullscreenElement&&q&&(q=!1);b&&console.log("fullscreenchange",document.fullscreenElement,a)});document.addEventListener("fullscreenerror",function(a){q=!1;b&&console.log("fullscreenerror",document.fullscreenElement,a);m=!0;document.exitFullscreen&&document.exitFullscreen()});h(document,"fullscreenElement");h(document,"exitFullscreen");
h(Element.prototype,"requestFullscreen");h(document,"fullscreenEnabled");h(document,"onfullscreenchange");h(document,"onfullscreenerror");(function(){if(!g){g=!0;for(var a=function(a){a=c(d("fullscreenchange"),a);document.dispatchEvent(a)},b=function(a){a=c(d("fullscreenerror"),a);document.dispatchEvent(a)},e=0,h=f.onfullscreenchange.length;e<h;e++)void 0!==document[f.onfullscreenchange[e]]&&(document[f.onfullscreenchange[e]]=a);e=0;for(h=f.onfullscreenerror.length;e<h;e++)void 0!==document[f.onfullscreenerror[e]]&&
(document[f.onfullscreenerror[e]]=b)}})();(function(){if(!p.fullscreenElement){p.fullscreenElement=!0;var a=Object.getOwnPropertyDescriptor(Document.prototype,"fullscreenElement")||{get:function(){return document[e.fullscreenElement]},set:function(a){document[e.fullscreenElement]=a}};Object.defineProperty(document,"fullscreenElement",{get:function(){if(m)return b&&console.log("get fullscreenElement",n),n;b&&console.log("get fullscreenElement",document[e.fullscreenElement]);return a.get.apply(document)},
set:function(b){return a.set.apply(document,b)}})}})();(function(){if(!p.fullscreenEnabled){p.fullscreenEnabled=!0;var a=Object.getOwnPropertyDescriptor(Document.prototype,"fullscreenEnabled")||{get:function(){return document[e.fullscreenEnabled]}};Object.defineProperty(document,"fullscreenEnabled",{get:function(){if(m)return b&&console.log("get fullscreenEnabled",!0),!0;b&&console.log("get fullscreenEnabled",document[e.fullscreenEnabled]);return a.get.apply(document)}})}})();(function(){if(!p.exitFullscreen){p.exitFullscreen=
!0;var a=document[e.exitFullscreen];document.exitFullscreen=function(){b&&console.log("exitFullscreen");if(m)n=null,document.dispatchEvent(d("fullscreenchange"));else return a.apply(document,arguments)}}})();(function(){if(!p.requestFullscreen){p.requestFullscreen=!0;var a=Element.prototype[e.requestFullscreen];Element.prototype.requestFullscreen=function(){q=!0;b&&console.log("requestFullscreen",this);if(m)n=this,document.dispatchEvent(d("fullscreenchange"));else return a.apply(this,arguments)}}})();
(function(){"onfullscreenchange"===e.onfullscreenchange||p.onfullscreenchange||(p.onfullscreenchange=!0,Object.defineProperty(document,"onfullscreenchange",{get:function(){b&&console.log("get onfullscreenchange",document[e.onfullscreenchange]);return document[e.onfullscreenchange]},set:function(a){b&&console.log("set onfullscreenchange",document[e.onfullscreenchange]);document[e.onfullscreenchange]=a}}))})();(function(){"onfullscreenerror"===e.onfullscreenerror||p.onfullscreenerror||(p.onfullscreenerror=
!0,Object.defineProperty(document,"onfullscreenerror",{get:function(){b&&console.log("get onfullscreenerror",document[e.onfullscreenerror]);return document[e.onfullscreenerror]},set:function(a){b&&console.log("set onfullscreenerror",document[e.onfullscreenerror]);document[e.onfullscreenerror]=a}}))})();window.removeEventListener("keyup",a);window.addEventListener("keyup",a);m=!document.fullscreenEnabled;window.fullscreenPolyfill={};Object.defineProperties(window.fullscreenPolyfill,{useFullWindow:{get:function(){return m},
set:function(a){m=a},enumerable:!0},api:{get:function(){return e},enumerable:!0},applied:{get:function(){return p},enumerable:!0},debug:{get:function(){return b},set:function(a){b=a}}});k?l?console.log("Fullscreen API (from perfect API)."):console.log("Fullscreen API (from partially implemented API)."):console.log("Fullscreen API (from broken API).")}})();var MediaUI=Class.extend({media$write:null,options$write:null,source$write:null,$source$write:null,el$write:null,$el$write:null,inputs:null,outputs:null,constructor:function MediaUI(a,b){if(!b.uienabled)return this.destroy();this.media=a;this.media.ui=this.media.ui||new MediaUIList;this.media.ui.add(this);this.options=b||{};this.options instanceof Media.DefaultOptions||(this.options=new Media.DefaultOptions(b));Media.changes.hold(this.media);this.options.add({ui:this});this.source=a.el;this.$source=
elements(a.el);this.inputs={};this.outputs={};this.listenTo(a,{destroyed:this.onDestroyed});MediaUI.layouts.load(this.options,function(a){this.options.uilayout=a;this.ensureElement();this.processOptions();this.startControllers();this.startOutputs();this.startInputs();Media.changes.resume(this.media);this.trigger("ready")}.bind(this))},$:function(a){return this.$el.query(a)},$all:function(){var a=this.$("*");a.unshift(this.el);return a},ensureElement$write:function(){this.el=this.options.el||this.getRenderedTemplate();
this.$el=elements(this.el)},getRenderedTemplate$write:function(){var a=this.options.uilayout.template(this.options);if(a){var b=document.createElement("div");b.innerHTML=a;return b.children[0]}},processOptions$write:function(){this.originalAttributes=this.$source.attrs();if(this.options.uireplace){var a=this.$("*").filterByAttribute(this.options.outputattribute,"mediaseat");this.$source.replaceWith(this.el);a.prepend(this.source)}this.options.videoplaysinline&&"VIDEO"===this.source.tagName&&this.source.setAttribute("playsinline",
!0);this.source.setAttribute("tabindex","-1");this.source.setAttribute("aria-hidden","true")},startControllers$write:function(){for(var a in MediaUI.Controller){var b=MediaUI.Controller[a];b.prototype instanceof MediaUI.Controller&&(this[a.toLowerCase()]=new b(this))}},startInputs$write:function(){for(var a in MediaUI.Input){var b=MediaUI.Input[a];b.prototype instanceof MediaUI.Input&&(this.inputs[a.toLowerCase()]=new b(this))}},startOutputs$write:function(){for(var a in MediaUI.Output){var b=MediaUI.Output[a];
b.prototype instanceof MediaUI.Output&&(this.outputs[a.toLowerCase()]=new b(this))}},unprocessOptions$write:function(){this.options.uireplace&&this.$el.replaceWith(this.source);this.$source.attrs(this.originalAttributes)},onDestroyed:function(){this.unprocessOptions();this.media.ui.remove(this);this.outputs=this.inputs=this.$el=this.el=this.$source=this.source=this.options=this.media=null;this.destroy()}},{Input$write:MediaUIInput,Output$write:MediaUIOutput,Controller$write:MediaUIController},{instanceEvents:!0});
Media.DefaultOptions.add({videoplaysinline:!1,classprefix:"mediaui--",outputattribute:"data-media-output",inputattribute:"data-media-input",ui:null,uienable:!1,uireplace:!1});"undefined"===typeof exports?window.MediaUI=MediaUI:exports.MediaUI=MediaUI;$&&$.fn&&(Media=("undefined"===typeof exports?window:exports).Media,MediaUI=("undefined"===typeof exports?window:exports).MediaUI,Media.JQueryDefaultOptions=Media.DefaultOptions.extend({constructor:function(){Media.DefaultOptions.apply(this,arguments)}}),Media.JQueryDefaultOptions.add({uienabled:!0,uireplace:!0}),$.fn.medias=function(a){var b=this.find(Media.supportedTags);b=b.add(this.filter(Media.supportedTags));switch(a){case "destroy":return b.each(function(a,b){b[Media.propName]instanceof Media&&
b[Media.propName].destroy()}),b}b.each(function(b,d){d[Media.propName]?d[Media.propName].options.add(a):(b=new Media.JQueryDefaultOptions(a),d=new Media(d,b),MediaUI&&new MediaUI(d,b))});return b},$.fn.play=function(){var a=this.find(Media.supportedTags);a=a.add(this.filter(Media.supportedTags));a.each(function(a,c){c.paused&&(a=c.play&&c.play())&&a.then(function(){},function(a){console.log(a)})})},$.fn.rewind=function(){var a=this.find(Media.supportedTags);a=a.add(this.filter(Media.supportedTags));
...
c.lines[0].indexOf("--\x3e")&&(c.title=c.lines[0],c.lines.shift());if(-1===c.lines[0].indexOf("--\x3e")){this.readyState=Media.Class.TextTrack.READYSTATE.ERROR;break}else extend(c,this.parseTimePlacement(c.lines[0])),c.lines.shift();var k=new Media.Class.TextTrackCue(c.startTime,c.endTime,c.lines.join("\n"));k.defineProperties({track$write:this});k.lineAlign=c.align;k.line=c.line;k.position=c.position;k.size=c.size;k.vertical=c.vertical;this.addCue(k)}}catch(h){return console.log(h),!1}return!0},
...
Media.utils.isObject=isObject;Media.utils.extend=extend;Media.utils.extendNotEnumerable=extendNotEnumerable;Media.utils.defaults=defaults;Media.utils.indexOfRegex=indexOfRegex;Media.utils.lastIndexOfRegex=lastIndexOfRegex;Media.utils.includes=includes;Media.utils.replace=replace;Media.utils.clamp=clamp;Media.utils.isNumber=isNumber;Media.utils.parseUnit=parseUnit;Media.utils.makeUnit=makeUnit;Media.utils.delay=delay;Media.utils.debounce=debounce;Media.utils.getURL=getURL;MediaUI.defineProperties({Language$write:Class.extend({constructor:function(a,b){this.defineProperties({_isLoaded$write:!1,_hash$write:null});this.langCode=a;this.hash=b},isLoaded$get$enum:function(){return this._isLoaded},hash$set$enum:function(a){a&&(this._hash=a,this._isLoaded=!0,MediaUI.languages.trigger("language:"+this.langCode,this))},hash$get$enum:function(){return this._hash}})});MediaUI.defineProperties({Languages:List.extend({constructor:function(){},load$enum$write:function(a,b){a=a||{};a.uilangcode=a.uilangcode||"en";a.uilangpath=a.uilangpath||"./lang/";a.uilangextension=a.uilangextension||".txt";var c=this.search(a.uilangcode);this.once("language:"+a.uilangcode,function(a){b&&b(a)});c?c.isLoaded&&MediaUI.languages.trigger("language:"+a.uilangcode,c):(c=this.add(a.uilangcode),getURL(a.uilangpath+a.uilangcode+a.uilangextension,function(a){c.hash=JSON.parse(a)}.bind(this),
function(){throw"Could not find media player language `"+a.uilangcode+"`";}.bind(this)))},add$enum$write:function(a,b){a=new MediaUI.Language(a,b);this.push(a);return a},search$enum$write:function(a){for(var b,c=0,d=this.length;c<d;c++){var e=this[c];if(e.langCode===a){b=e;break}}return b||null}},null,{instanceEvents:!0})});MediaUI.defineProperties({languages$enum$write:new MediaUI.Languages});Media.DefaultOptions.add({uilangcode:"en",uilangpath:"./lang/",uilangextension:".txt"});MediaUI.defineProperties({Layout$write:Class.extend({constructor:function(a,b){this.defineProperties({_isLoaded$write:!1,_template$write:null});this.layoutName=a;this.template=b},isLoaded$get$enum:function(){return this._isLoaded},template$set$enum:function(a){a&&(this._template=a,this._isLoaded=!0,MediaUI.layouts.trigger("layout:"+this.layoutName,this))},template$get$enum:function(){return this._template}})});MediaUI.defineProperties({Layouts:List.extend({constructor:function(){},load$enum$write:function(a,b){a=a||{};a.uilayoutname=a.uilayoutname||"default";a.uilayoutpath=a.uilayoutpath||"./layout/";a.uilayoutextension=a.uilayoutextension||".html";var c=this.search(a.uilayoutname);this.once("layout:"+a.uilayoutname,function(a){b&&b(a)});c?c.isLoaded&&MediaUI.layouts.trigger("layout:"+a.uilayoutname,c):(c=this.add(a.uilayoutname),getURL(a.uilayoutpath+a.uilayoutname+a.uilayouttemplateextension,function(a){c.template=
function(b){return replace(a,b)}}.bind(this),function(){throw"Could not find media player layout `"+a.uilayoutname+"`";}.bind(this)))},add$enum$write:function(a,b){a=new MediaUI.Layout(a,b);this.push(a);return a},search$enum$write:function(a){for(var b,c=0,d=this.length;c<d;c++){var e=this[c];if(e.layoutName===a){b=e;break}}return b||null}},null,{instanceEvents:!0})});MediaUI.defineProperties({layouts$enum$write:new MediaUI.Layouts});
Media.DefaultOptions.add({uilayout:null,uilayoutpath:"./layout/",uilayoutname:"default",uilayouttemplateextension:".html"});MediaUI.Controller.Captions=MediaUI.Controller.extend({ui:null,constructor:function(a){MediaUI.Controller.apply(this,arguments);this.ui=a},isActive$get$enum:function(){return!!this.ui.media.tracks.default}});MediaUI.Controller.FullScreen=MediaUI.Controller.extend({ui:null,constructor:function(a){MediaUI.Controller.apply(this,arguments);this.ui=a},isDisabled$get$enum:function(){return!this.ui.options.uiallowfullscreen},isActive$get$enum:function(){return this.ui.el===document.fullscreenElement||document.fullscreenElement===this.ui.source},type$get$enum:function(){return window.fullscreenPolyfill.useFullWindow?"fullwindow":"browser"}});Media.DefaultOptions.add({uiallowfullscreen:!0});MediaUI.Controller.Poster=MediaUI.Controller.extend({ui:null,constructor:function(a){MediaUI.Controller.apply(this,arguments);this.ui=a},value$get:function(){return this.ui.source.poster||this.ui.source.getAttribute("poster")}});MediaUI.Controller.Size=MediaUI.Controller.extend({ui:null,constructor:function(a){MediaUI.Controller.apply(this,arguments);this.ui=a},height:function(a){return a.videoHeight||a.originalHeight||a.height},width:function(a){return a.videoWidth||a.originalWidth||a.width}});MediaUI.Controller.Src=MediaUI.Controller.extend({ui:null,constructor:function(a){MediaUI.Controller.apply(this,arguments);this.ui=a},value$get:function(){var a=this.ui.source.src||this.ui.source.getAttribute("src");if(a!==location.origin+location.pathname)return a}});MediaUI.Input.Engage=MediaUI.Input.extend({ui:null,isEngaged:!1,engageHandle:null,constructor:function(a){MediaUI.Input.apply(this,arguments);this.ui=a;this.setUpListeners()},setUpListeners:function(){this.listenTo(Media.device,{typed:this.onTyped});this.listenTo(this.ui,{begininput:this.onBeginInput,tap:this.onTap,endinput:this.onEndInput,ready:this.onUIReady});this.listenTo(this.ui.media,{play:this.startDisengage,"pause skip":this.engage})},onUIReady$bind:function(){this.engage()},onBeginInput$bind:function(a){this.ui.media.el.paused||
(this.isInInput=!0,Media.device.wasUsingTouchRecently||(this.stopDisengage(),this.engage()))},onTap$bind:function(a){this.ui.media.el.paused||this.checkForceEngage(a)||(this.isEngaged&&Media.device.wasUsingTouchRecently?this.disengage():this.engage())},onTyped$bind:function(a){this.ui.media.el.paused||this.engage()},onEndInput$bind:function(a){this.ui.media.el.paused||Media.device.wasUsingTouchRecently||this.checkForceEngage(a)||this.startDisengage()},checkForceEngage:function(a){if("mouseout"===
a.type)return!1;a=elements(a.target);return a.path().filterByAttribute(this.ui.options.inputattribute,"engage").length&&!a.isHidden()?(this.stopDisengage(),!0):!1},engage$bind:function(){this.stopDisengage();this.isEngaged||(this.isEngaged=!0,this.ui.trigger("engage"))},disengage$bind:function(){this.isEngaged&&(this.isEngaged=!1,this.ui.trigger("disengage"))},startDisengage:function(){!Media.device.wasUsingTouchRecently&&this.isEngaged&&(this.engageHandle&&this.stopDisengage(),this.engageHandle=
setTimeout(this.disengage,this.ui.options.uiengagetimeout||2E3))},stopDisengage:function(){this.engageHandle&&(clearTimeout(this.engageHandle),this.engageHandle=null)},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.ui=null}});Media.DefaultOptions.add({uiengagetimeout:2E3});MediaUI.Input.FocusBlur=MediaUI.Input.extend({ui:null,isInFocus:!1,constructor:function(a){MediaUI.Input.apply(this,arguments);this.ui=a;this.setUpListeners()},setUpListeners:function(){elements(document.body).on({focusin:this.onFocus},{passive:!0})},onFocus$bind:function(a){elements(a.target).parents().filter(function(a){return a===this.ui.el}.bind(this)).length?(this.ui.trigger("begininput",a),this.isInFocus=!0):this.isInFocus&&(this.isInFocus=!1,this.ui.trigger("endinput",a))},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,
arguments);elements(document.body).off({focusin:this.onFocus});this.ui=null}});MediaUI.Input.ScrubCurrentTime=MediaUI.Input.extend({ui:null,$els:null,wasPlaying:!1,isMouseDown:!1,inTouch:!1,constructor:function(a){MediaUI.Input.apply(this,arguments);this.ui=a;this.$els=this.ui.$all().filterByAttribute(this.ui.options.inputattribute,"scrubcurrenttime");this.addEventListeners()},addEventListeners:function(){this.$els.on({mousedown:this.onMouseDown,touchstart:this.onTouchStart},{passive:!1});elements(document.body).on({mouseup:this.onMouseUp,mousemove:this.onMouseMove},{passive:!0});
elements(document.body).on({touchend:this.onTouchEnd,touchmove:this.onTouchMove},{passive:!1})},onMouseDown$bind:function(a){a.buttons&1&&(a.stopPropagation(),this.wasPlaying=!this.ui.source.paused,this.isMouseDown=!0,this.ui.source.pause(),a=a.clientX,this.ui.media.dispatchEvent("scrubbing"),this.setTimeFromLeft(a))},onMouseMove$bind:function(a){if(this.isMouseDown)if(a.buttons&1)this.setTimeFromLeft(a.clientX);else this.onMouseUp()},onMouseUp$bind:function(){this.isMouseDown=!1;this.wasPlaying&&
(this.wasPlaying=!1,this.ui.source.play());this.ui.media.dispatchEvent("scrubbed")},onTouchStart$bind:function(a){this.wasPlaying=!this.ui.source.paused;this.inTouch=!0;this.ui.source.pause();a=a.touches[0].clientX;this.ui.media.dispatchEvent("scrubbing");this.setTimeFromLeft(a)},onTouchMove$bind:function(a){this.inTouch&&this.setTimeFromLeft(a.touches[0].clientX)},onTouchEnd$bind:function(a){this.inTouch=!1;this.wasPlaying&&(a.stopPropagation(),this.wasPlaying=!1,this.ui.source.play());this.ui.media.dispatchEvent("scrubbed")},
setTimeFromLeft:function(a){if(this.ui.source.duration){var b=this.$els[0].getBoundingClientRect(),c=this.$els[0].clientWidth;a=clamp(0,a-b.left,c);this.ui.source.currentTime=a/c*this.ui.source.duration;this.ui.media.dispatchEvent("timeupdate",{slow:!0})}},removeEventListeners:function(){this.$els.off({mousedown:this.onMouseDown,touchstart:this.onTouchStart});elements(document.body).off({mouseup:this.onMouseUp,mousemove:this.onMouseMove,touchend:this.onTouchEnd,touchmove:this.onTouchMove},{passive:!0})},
destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.removeEventListeners();this.$els=this.ui=null}});Media.DOMEvents.add(["scrubbing","scrubbed"]);MediaUI.Input.ScrubCurrentTimeAria=MediaUI.Input.extend({ui:null,$els:null,wasPlaying:!1,isMouseDown:!1,inTouch:!1,constructor:function(a){MediaUI.Input.apply(this,arguments);this.ui=a;this.$els=this.ui.$all().filterByAttribute(this.ui.options.inputattribute,"scrubcurrenttimearia");this.addEventListeners()},addEventListeners:function(){this.$els.on({keydown:this.onKeyDown},{passive:!1})},onKeyDown$bind:function(a){if(a.target===document.activeElement)switch(a.keyCode){case 37:case 40:this.moveTimeBySeconds(-1);
...
destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.removeEventListeners();this.$els=this.ui=null}});MediaUI.Input.Skip=MediaUI.Input.extend({ui:null,interactions:null,lastEvent:0,skipped:0,constructor:function(a){MediaUI.Input.apply(this,arguments);this.interactions=[];this.clear=debounce(this.clear.bind(this),500);this.ui=a;this.listenTo(this.ui,{tap:this.onSingleTap,dbltap:this.onDoubleTap})},onSingleTap:function(a){this.ui.options.uiskip&&Media.device.wasUsingTouchRecently&&(this.interactions.length=0)},onDoubleTap$bind:function(a){if(this.ui.options.uiskip&&Media.device.wasUsingTouchRecently&&
elements(a.target).path().filterByAttribute(this.ui.options.inputattribute,"skip").length){a.preventDefault();Date.now();var b=a.target.offsetParent,c=b.getBoundingClientRect();a=("touchend"===a.type?a.changedTouches[0].clientX-c.left:a.offsetX)/b.clientWidth;this.interactions.push({direction:.5>a?"left":.5<a?"right":"none"});this.skip();this.clear()}},skip:function(){var a=this.getSkipAmount();if(a){var b=a-this.skipped,c=this.ui.source.currentTime;if(b=clamp(-c,b,this.ui.source.duration-c))this.ui.source.currentTime+=
b,this.skipped+=b,this.ui.media.dispatchEvent("skip",{skipAmount:a}),this.ui.media.dispatchEvent("timeupdate",{fast:!0,medium:!0,slow:!0})}},clear:function(){this.getSkipAmount()&&(this.skipped=this.interactions.length=0)},getSkipAmount:function(){var a=this.interactions.slice(0);if(void 0!==a){for(var b=this.ui.options.uiskipseconds||10,c=0,d=0,e=0,f=a.length;e<f;e++)switch(a[e].direction){case "left":d++;break;case "right":c++}if((c||d)&&0!==c-d)return(d>c?-(d-c):c-d)*b}}});
Media.DefaultOptions.add({uiskip:!0,uiskipseconds:10});Media.DOMEvents.add("skip");MediaUI.Input.Taps=MediaUI.Input.extend({ui:null,$els:null,isMouseDown:!1,isTouchDown:!1,lastEnd:0,taps:0,tapHandle:null,constructor:function(a){MediaUI.Input.apply(this,arguments);this.ui=a;this.$els=this.ui.$("*").filterByAttribute(this.ui.options.inputattribute,"taps");this.setUpListeners()},setUpListeners:function(){this.listenTo(this.ui,{stoptap:this.stopSingleTap});this.$els.on({touchstart:this.onTouchStart,mousedown:this.onMouseDown},{passive:!1});this.$els.on({mousemove:this.onMouseMove,mouseout:this.onMouseOut},
{passive:!0});elements(document.body).on({mouseup:this.onMouseUp,touchend:this.onTouchEnd},{passive:!1})},onTouchStart$bind:function(a){this.isTouchDown=!0;this.ui.trigger("begininput",a)},onMouseDown$bind:function(a){!Media.device.wasUsingTouchRecently&&!this.isTouchDown&&a.buttons&1&&(this.isMouseDown=!0,this.ui.trigger("begininput",a))},onMouseMove$bind:function(a){Media.device.wasUsingTouchRecently||this.isMouseDown||this.isTouchDown||this.tapHandle||(this.ui.trigger("begininput",a),this.ui.trigger("endinput",
a))},onMouseOut$bind:function(a){Media.device.wasUsingTouchRecently||this.isMouseDown||this.isTouchDown||this.ui.trigger("endinput",a)},onMouseUp$bind:function(a){!Media.device.wasUsingTouchRecently&&this.isMouseDown&&(this.isMouseDown=!1,this.ui.trigger("endinput",a),this.onEndInput(a))},onTouchEnd$bind:function(a){this.isTouchDown&&(this.isTouchDown=!1,this.ui.trigger("endinput",a),this.onEndInput(a))},onEndInput$bind:function(a){this.stopSingleTap();if(!this.isNoTaps(a)){this.taps++;var b=Date.now();
...
(this.taps=0,this.ui.trigger("tap",this.singleTapEvent))},isNoTaps:function(a){return elements(a.target).path().filterByAttribute(this.ui.options.inputattribute,"stoptappropagation").length},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.$els.off({touchstart:this.onTouchStart,mousedown:this.onMouseDown,mousemove:this.onMouseMove,mouseout:this.onMouseOut});elements(document.body).off({mouseup:this.onMouseUp,touchend:this.onTouchEnd});this.$els=this.ui=null}});Media.DefaultOptions.add({uitapinterval:300});MediaUI.Input.ToggleCaptions=MediaUI.Input.extend({ui:null,$els:null,constructor:function(a){MediaUI.Input.apply(this,arguments);this.ui=a;this.$els=this.ui.$all().filterByAttribute(this.ui.options.inputattribute,"togglecaptions");this.$els.on({click:this.onClick})},onClick$bind:function(){this.ui.captions.isActive?this.ui.media.tracks.default.default=!1:this.ui.media.tracks.length&&(this.ui.media.tracks[0].default=!0,this.ui.media.dispatchEvent("timeupdate",{fast:!0,medium:!0,slow:!0}))},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,
arguments);this.$els.off("click",this.onClick);this.ui=null}});MediaUI.Input.ToggleFullScreen=MediaUI.Input.extend({ui:null,$els:null,constructor:function(a){MediaUI.Input.apply(this,arguments);this.ui=a;this.$els=this.ui.$all().filterByAttribute(this.ui.options.inputattribute,"togglefullscreen");this.$els.on({click:this.onClick});this.listenTo(this.ui,{dbltap:this.onDoubleTap})},onClick$bind:function(){var a=this.ui.options;a.uiallowfullscreen&&(this.ui.options.usefullwindow&&(window.fullscreenPolyfill.useFullWindow=!0),Media.device.isIOS&&a.iosnativefullscreen?
document.fullscreenElement?document.exitFullscreen():this.ui.source.requestFullscreen():document.fullscreenElement?document.exitFullscreen():this.ui.el.requestFullscreen())},onDoubleTap$bind:function(){if(this.ui.options.uiallowfullscreen&&!Media.device.wasUsingTouchRecently)this.onClick()},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.$els.off("click",this.onClick);this.ui=null}});Media.DefaultOptions.add({iosnativefullscreen:!0,usefullwindow:!1});MediaUI.Input.ToggleMute=MediaUI.Input.extend({ui:null,$els:null,requiredAPI$write:["muted"],constructor:function(a){MediaUI.Input.apply(this,arguments);this.ui=a;this.$els=this.ui.$all().filterByAttribute(this.ui.options.inputattribute,"togglemute");this.$els.on({click:this.onClick})},onClick$bind:function(){this.ui.media.hasAPI(this.requiredAPI)&&(this.ui.source.muted=!this.ui.source.muted)},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.$els.off("click",this.onClick);
this.ui=null}});MediaUI.Input.TogglePlayPause=MediaUI.Input.extend({ui:null,$els:null,requiredAPI$write:["paused","play","pause"],constructor:function(a){MediaUI.Input.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.inputattribute,"toggleplaypause");this.$els.length&&(this.ui=a,this.$els.on({click:this.onClick}),this.listenTo(this.ui,{tap:this.onTap}))},onClick$bind:function(a){a.stopPropagation();elements(a.target).isHidden()||(this.ui.trigger("stoptap"),this.toggle())},onTap$bind:function(a){if(this.ui.options.uitaptoplaypause){a=
elements(a.target);var b=a.path().filterByAttribute(this.ui.options.inputattribute,"toggleplaypausenotouch");a.isHidden()||!b.length||Media.device.wasUsingTouchRecently||this.toggle()}},toggle:function(){this.ui.media.hasAPI(this.requiredAPI)&&(this.ui.source.paused?this.ui.source.play():this.ui.source.pause())},destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.$els.off("click",this.onClick);this.ui=null}});Media.DefaultOptions.add({uitaptoplaypause:!0});MediaUI.Output.BigPlayPauseState=MediaUI.Output.extend({ui:null,$els:null,requiredAPI:["paused"],constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"bigplaypausestate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{change:this.onUpdate}),this.onUpdate())},onUpdate:function(a){this.$els.length&&(a=this.ui.options,this.ui.media.hasAPI(this.requiredAPI)&&this.ui.options.uishowbigplaypause&&this.ui.src.value?rafer.call(this.$els,
"toggleClass",replace("${classprefix}bigplaypausestate-hidden",a),!1):rafer.call(this.$els,"toggleClass",replace("${classprefix}bigplaypausestate-hidden",a),!0))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});Media.DefaultOptions.add({uishowbigplaypause:!0});MediaUI.Output.BufferedWidth=MediaUI.Output.extend({ui:null,$els:null,requiredAPI$write:["duration","buffered","seekable"],constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"bufferedwidth");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"timeupdate postresize ended change":this.onTimeUpdate,destroyed:this.destroy}),this.onTimeUpdate())},onTimeUpdate:function(a){a&&"timeupdate"===a.type&&!a.medium||this.update()},
update:function(){if(this.$els.length){var a=this.ui.source.duration,b=this.ui.source.buffered;if(this.ui.media.hasAPI(this.requiredAPI)&&this.ui.source.src){!b.length&&this.ui.source.seekable.length&&(b=this.ui.source.seekable);for(var c=0,d=0,e=b.length;d<e;d++){var f=b.end(d);c<f&&(c=f)}a=(c-0)/a||0;b=0;for(c=this.$els.length;b<c;b++)d=this.$els[b],rafer.set(d.style,"width",100*a+"%")}else for(b=0,c=this.$els.length;b<c;b++)d=this.$els[b],rafer.set(d.style,"width","0%")}},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,
arguments);this.$els=this.ui=null}});MediaUI.Output.Captions=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.ui=a;this.getElements();this.setUpListeners()},getElements:function(){this.$els=this.ui.$("*:not(track)").filterByAttribute(this.ui.options.outputattribute,"captions");this.ui.media.tracks&&1<this.ui.media.tracks.length&&console.warn("MediaUI: doesn't yet support multiple text tracks.")},setUpListeners:function(){this.listenTo(this.ui.media,{"addtexttrack texttrackchange removetexttrack":this.onTextTrackChange,
cueenter:this.onCueEnter,cueexit:this.onCueExit})},onTextTrackChange$bind:function(a){this.$els.forEach(function(a){rafer.set(a,"innerHTML","")})},onCueEnter$bind:function(a){this.$els.forEach(function(b){rafer.call(b,"appendChild",a.cue.getCueAsHTML())})},onCueExit$bind:function(a){this.$els.forEach(function(b){b=b.querySelectorAll("#"+a.cue.id);for(var c=0,d=b.length;c<d;c++){var e=elements(b[c]);rafer.call(e,"remove")}})},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);
this.$els=this.ui=null}});MediaUI.Output.CaptionsAria=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"captionsaria");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{texttrackchange:this.onUpdate}),this.onUpdate())},onUpdate:function(a){this.$els.length&&MediaUI.languages.load(this.ui.options,function(a){var b=this.ui.captions.isActive;a=b?replace("${Captions}",a.hash):replace("${captions off}",a.hash);
rafer.call(this.$els,"attr","aria-label",a);rafer.call(this.$els,"attr","aria-pressed",b)}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.CaptionsState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"captionsstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"addtexttrack texttrackchange removetexttrack":this.onTextTrackChange}),this.onTextTrackChange())},onTextTrackChange$bind:function(a){this.ui.media.tracks&&this.ui.media.tracks.length&&this.ui.src.value?(rafer.call(this.$els,"toggleClass",
this.ui.options.classprefix+"captionsstate-disabled",!1),rafer.call(this.$els,"toggleClass",this.ui.options.classprefix+"captionsstate-inactive",!this.ui.captions.isActive),rafer.call(this.$els,"toggleClass",this.ui.options.classprefix+"captionsstate-active",this.ui.captions.isActive)):(rafer.call(this.$els,"toggleClass",this.ui.options.classprefix+"captionsstate-disabled",!0),rafer.call(this.$els,"toggleClass",this.ui.options.classprefix+"captionsstate-inactive",!0),rafer.call(this.$els,"toggleClass",
this.ui.options.classprefix+"captionsstate-active",!1))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.ControlBarOrder=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"controlbarorder");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{change:this.reorder}),this.reorder())},reorder:function(){var a={};(this.ui.options.uicontrolbarorder||["playpause","rail","mute","captions","fullscreen"]).forEach(function(b,c){a[b]=c+1});this.$els.forEach(function(b){var c=elements(b);
b=c.children();var d=b.map(function(b){var c=b.getAttribute(this.ui.options.controlbarorderattribute);return{el:b,order:c&&a[c]||null}}.bind(this));d.sort(function(a,b){return null===a.order&&null===b.order?0:null===a.order?-1:null===b.order?1:a.order-b.order}.bind(this));b.remove();d.forEach(function(a){a.order&&c.append(a.el)})}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});
Media.DefaultOptions.add({controlbarorderattribute:"data-media-controlbarorder",uicontrolbarorder:["playpause","rail","mute","captions","fullscreen"]});MediaUI.Output.ControlsState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"controlsstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{change:this.onUpdate}),this.onUpdate())},onUpdate:function(a){this.$els.length&&(a=this.ui.options,a.uiallowcontrols&&this.ui.src.value?(rafer.call(this.$els,"toggleClass",replace("${classprefix}controlsstate-disabled",a),!1),rafer.call(this.$els,
"toggleClass",replace("${classprefix}controlsstate-force",a),a.uialwaysshowcontrols)):(rafer.call(this.$els,"toggleClass",replace("${classprefix}controlsstate-disabled",a),!0),rafer.call(this.$els,"toggleClass",replace("${classprefix}controlsstate-force",a),!1)))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});Media.DefaultOptions.add({uialwaysshowcontrols:!1,uiallowcontrols:!0});MediaUI.Output.CurrentTimeAria=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"currenttimearia");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"timeupdate change":this.onUpdate}),this.onUpdate())},onUpdate:function(a){(!a||a.fake&&a.medium)&&this.$els.length&&MediaUI.languages.load(this.ui.options,function(a){var b=parseInt(this.ui.source.currentTime||0),d=parseInt(this.ui.source.duration||
0);a=a.hash["Progress Bar"]+" "+a.hash["progress bar timing: currentTime={1} duration={2}"].replace("{1}",b).replace("{2}",d);rafer.call(this.$els,"attr","role","slider");rafer.call(this.$els,"attr","aria-valuemax",d);rafer.call(this.$els,"attr","aria-valuemin",0);rafer.call(this.$els,"attr","aria-valuenow",b);rafer.call(this.$els,"attr","aria-label",a)}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.CurrentTimeWidth=MediaUI.Output.extend({ui:null,$els:null,requiredAPI:["currentTime","duration"],constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"currenttimewidth");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"timeupdate postresize ended change":this.onTimeUpdate,destroyed:this.destroy}),this.onTimeUpdate())},onTimeUpdate:function(a){a&&"timeupdate"===a.type&&!a.medium||this.update()},update:function(){if(this.$els.length)if(this.ui.media.hasAPI(this.requiredAPI)&&
this.ui.source.src){var a=this.ui.source.currentTime/this.ui.source.duration||0;b=0;for(c=this.$els.length;b<c;b++)d=this.$els[b],rafer.set(d.style,"width",100*a+"%")}else for(var b=0,c=this.$els.length;b<c;b++){var d=this.$els[b];rafer.set(d.style,"width",0)}},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.EngageState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"engagestate");this.$els.length&&(this.ui=a,this.listenTo(this.ui,{engage:this.onEngage,disengage:this.onDisengage}))},onEngage$bind:function(){rafer.call(this.$els,"toggleClass",replace("${classprefix}engagestate-engaged",this.ui.options),!0);rafer.call(this.$els,"toggleClass",replace("${classprefix}engagestate-disengaged",
...
rafer.call(this.$els,"attr","aria-label",a);rafer.call(this.$els,"attr","aria-pressed",b)}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.FullScreenState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"fullscreenstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"resize change":this.onUpdate}),elements(document).on({fullscreenchange:this.onUpdate},{passive:!1}),this.onUpdate())},onUpdate$bind:function(a){this.ui.fullscreen.isDisabled||!this.ui.src.value?(this.$els.toggleClass(this.ui.options.classprefix+
"fullscreenstate-disabled",!0),this.$els.toggleClass(this.ui.options.classprefix+"fullscreenstate-"+this.ui.fullscreen.type,!1)):(this.$els.toggleClass(this.ui.options.classprefix+"fullscreenstate-disabled",!1),this.$els.toggleClass(this.ui.options.classprefix+"fullscreenstate-"+this.ui.fullscreen.type,this.ui.fullscreen.isActive))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);elements(document).off({fullscreenchange:this.onUpdate});this.$els=this.ui=null}});MediaUI.Output.KeyboardState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"keyboardstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui,{endinput:this.onUpdate}),this.listenTo(Media.device,{typed:this.onUpdate}),this.onUpdate())},onUpdate:function(a){a=Media.device.wasUsingKeyboardRecently;rafer.call(this.$els,"toggleClass",replace("${classprefix}keyboardstate-inactive",this.ui.options),
!a);rafer.call(this.$els,"toggleClass",replace("${classprefix}keyboardstate-active",this.ui.options),a)},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.LoopState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"loopstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"timeupdate play pause ended change":this.onUpdate}),this.onUpdate())},onUpdate:function(a){if((!a||"timeupdate"!==a.type||a.slow)&&this.$els.length){a=this.ui.source.loop;var b=this.ui.options;rafer.call(this.$els,"toggleClass",replace("${classprefix}loopstate-looping",
b),a);rafer.call(this.$els,"toggleClass",replace("${classprefix}loopstate-notlooping",b),!a)}},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.MuteAria=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"mutearia");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{volumechange:this.onUpdate}),this.onUpdate())},onUpdate:function(a){this.$els.length&&MediaUI.languages.load(this.ui.options,function(a){var b=!!this.ui.source.muted;a=b?replace("${Unmute}",a.hash):replace("${Mute}",a.hash);rafer.call(this.$els,
"attr","aria-label",a);rafer.call(this.$els,"attr","aria-pressed",b)}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.MuteState=MediaUI.Output.extend({ui:null,$els:null,requiredAPI:["muted"],constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"mutestate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"volumechange change":this.onUpdate}),this.onUpdate())},onUpdate$bind:function(){this.ui.media.hasAPI(this.requiredAPI)&&this.ui.src.value?(rafer.call(this.$els,"toggleClass",replace("${classprefix}mutestate-disabled",
this.ui.options),!1),rafer.call(this.$els,"toggleClass",replace("${classprefix}mutestate-muted",this.ui.options),this.ui.source.muted)):(rafer.call(this.$els,"toggleClass",replace("${classprefix}mutestate-disabled",this.ui.options),!0),rafer.call(this.$els,"toggleClass",replace("${classprefix}mutestate-muted",this.ui.options),!0))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.PlayPauseAria=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"playpausearia");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"play pause":this.onUpdate}),this.onUpdate())},onUpdate:function(a){this.$els.length&&MediaUI.languages.load(this.ui.options,function(a){var b=!!this.ui.source.paused;a=b?replace("${Play}",a.hash):replace("${Pause}",a.hash);rafer.call(this.$els,
"attr","aria-label",a);rafer.call(this.$els,"attr","aria-pressed",b?"false":"true")}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.PlayPauseState=MediaUI.Output.extend({floorPrecision:10,ui:null,$els:null,requiredAPI:["paused","currentTime","duration"],constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"playpausestate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"timeupdate play pause ended change":this.onUpdate}),this.onUpdate())},onUpdate:function(a){if((!a||"timeupdate"!==a.type||a.slow)&&this.$els.length)if(a=this.ui.options,
this.ui.media.hasAPI(this.requiredAPI)&&this.ui.src.value){var b=this.isAtStart(),c=this.isAtEnd(),d=this.ui.source.paused;rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-disabled",a),!1);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-playing",a),!d);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-paused",a),d);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-start",a),b);rafer.call(this.$els,"toggleClass",
replace("${classprefix}playpausestate-end",a),c);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-middle",a),!c&&!b)}else rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-disabled",a),!0),rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-playing",a),!1),rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-paused",a),!0),rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-start",a),!0),rafer.call(this.$els,
"toggleClass",replace("${classprefix}playpausestate-end",a),!1),rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-middle",a),!1)},isAtStart:function(){var a=this.ui.media.hasAPI(this.requiredAPI)&&this.ui.source.src?this.ui.source.currentTime:0;return 1>=Math.floor(a*this.floorPrecision)},isAtEnd:function(){var a=this.ui.media.hasAPI(this.requiredAPI)&&this.ui.source.src;return 1>=Math.abs(Math.floor((a?this.ui.source.currentTime:0)*this.floorPrecision)-Math.floor((a?this.ui.source.duration:
0)*this.floorPrecision))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.Poster=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"poster");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{change:this.onUpdate}),this.onUpdate())},onUpdate$bind:function(){var a=this.ui.source.getAttribute("poster");this.$els.forEach(function(b){switch(b.nodeName){case "IMG":b.src=a;break;default:b.style.backgroundImage="url("+a+")"}}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,
arguments);this.$els=this.ui=null}});MediaUI.Output.PosterState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"posterstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{change:this.onUpdate}),this.onUpdate())},onUpdate:function(a){this.$els.length&&(a=this.ui.options,a.uiallowposter&&this.ui.poster.value?(rafer.call(this.$els,"toggleClass",replace("${classprefix}posterstate-disabled",a),!1),rafer.call(this.$els,
"toggleClass",replace("${classprefix}posterstate-force",a),a.uialwaysshowposter)):(rafer.call(this.$els,"toggleClass",replace("${classprefix}posterstate-disabled",a),!0),rafer.call(this.$els,"toggleClass",replace("${classprefix}posterstate-force",a),!1)))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});Media.DefaultOptions.add({uialwaysshowposter:!1,uiallowposter:!0});MediaUI.Output.Resize=MediaUI.Output.extend({ui:null,$els:null,$elsinner:null,initial:!0,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"resize");this.$elsinners=a.$all().filterByAttribute(a.options.outputattribute,"resizeinner");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{resize:this.onResize}))},onOptionsChange:function(a,b,c){switch(a){case "mediasize":case "mediaposition":case "mediaratio":case "mediafullscreensize":case "mediafullscreenposition":case "mediafullscreenratio":case "uisize":case "uiposition":case "uiratio":case "uifullscreensize":case "uifullscreenposition":case "uifullscreenratio":this.onResize(Media.resize.getDimensions(this.ui.media))}},
onResize$bind:function(a){var b=this.getUIDimensions(),c=new Media.Class.Dimensions(this.ui.fullscreen.isActive?window:this.ui.el.offsetParent||window),d=b[this.ui.fullscreen.isActive?"fullscreen":"normal"];"auto"===d.height.unit&&"auto"===d.width.unit&&(d.height.value="contain",d.height.unit="contain",d.width.value="contain",d.width.unit="contain");"cover"===d.height.value&&(d.height.value="fill",d.height.unit="fill",d.width.value="fill",d.width.unit="fill");this.$els.forEach(function(a){var b=this.getStyles(a,
this.ui.source,c,d),e;for(e in b)this.initial?a.style[e]=b[e]:rafer.set(a.style,e,b[e])}.bind(this));var e=(b=!!elements(this.ui.source).path().find(function(a){return a===this.ui.el}.bind(this)))?this.ui.el.offsetParent:this.ui.source.offsetParent,f=new Media.Class.Dimensions(this.ui.fullscreen.isActive?window:e||window),g=a[this.ui.fullscreen.isActive?"fullscreen":"normal"];if(b)switch(d.height.value){case "contain":a="auto"===g.height.unit&&"auto"===g.width.unit;if("fill"===g.height.value||"cover"===
g.height.value||a)g.height.value="contain",g.height.unit="contain",g.width.value="contain",g.width.unit="contain";break;case "fill":if(a="auto"===g.height.unit&&"auto"===g.width.unit)g.height.value="cover",g.height.unit="cover",g.width.value="cover",g.width.unit="cover";break;case "retain":g.height.value="retain",g.height.unit="retain",g.width.value="retain",g.width.unit="retain"}this.$elsinners.forEach(function(a){var b=this.getStyles(a,this.ui.source,f,g,{usePxValues:!1,transform:Media.device.isIE11?
"scale(1.02)":""}),c;for(c in b)this.initial?a.style[c]=b[c]:rafer.set(a.style,c,b[c])}.bind(this));this.initial=!1},getStyles:function(a,b,c,d,e){e=e||{};e.transform=e.transform||"";a={"object-fit":"fill"};switch(d.width.unit){case "contain":d.ratio<=c.ratio?(a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%",a.width=makeUnit(c.height.value*d.ratio,c.height.unit)):(a.width=e.usePxValues?makeUnit(c.width.value,c.width.unit):"100%",a.height=makeUnit(c.width.value/d.ratio,c.width.unit));
break;case "cover":d.ratio<=c.ratio?(a.width=e.usePxValues?makeUnit(c.width.value,c.width.unit):"100%",a.height=makeUnit(c.width.value/d.ratio,c.width.unit)):(a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%",a.width=makeUnit(c.height.value*d.ratio,c.height.unit));break;case "retain":var f=clamp(0,c.height.value,this.ui.size.height(b));b=clamp(0,c.width.value,this.ui.size.width(b));d.ratio<=c.ratio?(a.height=makeUnit(f,c.height.unit),a.width=makeUnit(f*d.ratio,c.height.unit)):(a.width=
makeUnit(b,c.width.unit),a.height=makeUnit(b/d.ratio,c.width.unit));break;case "fill":a.width=e.usePxValues?makeUnit(c.width.value,c.width.unit):"100%";a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%";break;case "none":a.height="";a.width="";break;default:"auto"!==d.width.unit&&(a.width=makeUnit(d.width.value,d.width.unit)),"auto"!==d.height.unit&&(a.height=makeUnit(d.height.value,d.height.unit)),"auto"===d.width.unit&&(a.width=makeUnit(c.height.value*d.ratio,"px")),"auto"===d.height.unit&&
(a.height=makeUnit(c.width.value/d.ratio,"px"))}var g=!1;c=!1;b=["0","0"];f=["","","",""];switch(d.x.keyword){case "center":c=g=!0;f[3]="50%";b[0]="-50%";break;case "left":g=!0;f[3]=d.x.value;break;case "right":g=!0,f[1]=d.x.value}switch(d.y.keyword){case "center":c=g=!0;f[0]="50%";b[1]="-50%";break;case "top":g=!0;f[0]=d.y.value;break;case "bottom":g=!0,f[2]=d.y.value}a.position=g?"absolute":"";d=[e.transform];c&&d.unshift("translate("+b.join(",")+")");a.transform=d.length?d.join(" "):"";a.top=f[0];
a.right=f[1];a.bottom=f[2];a.left=f[3];return a},getUIDimensions:function(){var a=this.ui.options;return{fullscreen:new Media.Class.Dimensions(a.uifullscreensize,a.uifullscreenratio,a.uifullscreenposition),normal:new Media.Class.Dimensions(a.uisize,a.uiratio,a.uiposition)}},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.el=this.ui=null}});
Media.DefaultOptions.add({uisize:function(){return this.mediasize},uiratio:function(){return this.mediaratio},uiposition:"none none",uifullscreensize:function(){return this.uisize},uifullscreenratio:function(){return this.uiratio},uifullscreenposition:function(){return this.uiposition}});MediaUI.Output.ScrubbingState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"scrubbingstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{scrubbing:this.onScrubbing,scrubbed:this.onScrubbed}),this.onScrubbed())},onScrubbing$bind:function(){rafer.call(this.$els,"toggleClass",replace("${classprefix}scrubbingstate-active",this.ui.options),!0);rafer.call(this.$els,"toggleClass",
replace("${classprefix}scrubbingstate-inactive",this.ui.options),!1)},onScrubbed$bind:function(){rafer.call(this.$els,"toggleClass",replace("${classprefix}scrubbingstate-inactive",this.ui.options),!0);rafer.call(this.$els,"toggleClass",replace("${classprefix}scrubbingstate-active",this.ui.options),!1)},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.WaitingState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"waitingstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"loadstart seeking waiting stalled error":this.onWaiting,"canplay seeked playing timeupdate suspend pause":this.offWaiting}),this.offWaiting())},onWaiting:function(){if(!this.ui.src.value)return this.offWaiting();this.$els.forEach(function(a){a=
elements(a);rafer.call(a,"toggleClass",replace("${classprefix}waitingstate-active",this.ui.options),!0);rafer.call(a,"toggleClass",replace("${classprefix}waitingstate-inactive",this.ui.options),!1)}.bind(this))},offWaiting:function(){this.$els.forEach(function(a){a=elements(a);rafer.call(a,"toggleClass",replace("${classprefix}waitingstate-inactive",this.ui.options),!0);rafer.call(a,"toggleClass",replace("${classprefix}waitingstate-active",this.ui.options),!1)}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,
arguments);this.$els=this.ui=null}}); return exports;}));
