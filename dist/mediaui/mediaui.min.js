...
this.options.uilayout.template(this.options);if(a){var b=document.createElement("div");b.innerHTML=a;return b.children[0]}},processOptions$write:function(){this.originalAttributes=this.$source.attrs();if(this.options.uireplace){var a=this.$("*").filterByAttribute(this.options.outputattribute,"mediaseat");this.$source.replaceWith(this.el);a.prepend(this.source)}this.options.videoplaysinline&&"VIDEO"===this.source.tagName&&this.source.setAttribute("playsinline",!0);this.source.setAttribute("tabindex",
...
case 4:b=c}switch(b[0]){case "auto":switch(b[2]){case "auto":case "top":case "bottom":b[0]="left";break;case "left":case "right":b[0]="top"}}switch(b[2]){case "auto":switch(b[0]){case "auto":case "top":case "bottom":b[2]="left";break;case "left":case "right":b[2]="top"}}switch(b[2]){case "left":case "right":a=b[0],c=b[1],b[0]=b[2],b[1]=b[3],b[2]=a,b[3]=c}this.x={keyword:b[0],value:b[1]};this.y={keyword:b[2],value:b[3]}},position$get$enum:function(){return this._position}});Media.Class.DOMChanges=Media.Class.extend({constructor:function(a){this.listenTo(Media,{created:this.onCreated,destroyed:this.onDestroyed})},onCreated:function(a){var b=new MutationObserver(function(a,b){this.dispatchEvent("change",{mutations:a})}.bind(a));b.observe(a.el,{attributes:!0,childList:!0,subtree:!0});a.defineProperties({mutationobserver$value:b})},onDestroyed:function(a){a.mutationobserver.disconnect()}});Media.defineProperties({domchanges$write:new Media.Class.DOMChanges});Media.DOMEvents.add(["change"]);Media.Class.Ended=Media.Class.extend({floorPrecision$write:10,requiredAPI$write:["paused","pause","currentTime","duration"],constructor:function(){this.listenTo(Media,{created:this.onCreated,play:this.onPlay,"timeupdate pause":this.onUpdate,ended:this.onEnded})},onCreated$write:function(a){a.defineProperties({hasFiredEnded$write:!1})},onPlay$write:function(a){a.hasAPI(this.requiredAPI)&&(this.isEnded(a)&&a.hasFiredEnded&&(a.el.currentTime=0),a.hasFiredEnded=!1)},onUpdate$write:function(a){a.hasAPI(this.requiredAPI)&&
(!this.isEnded(a)||a.isAtEnd?a.hasFiredEnded=!1:setTimeout(function(){a.el&&!a.hasFiredEnded&&this.isEnded(a)&&(a.el.currentTime=a.el.duration,a.el.paused||a.el.pause(),a.dispatchEvent("ended"))}.bind(this),150))},onEnded$write:function(a){a.hasAPI(this.requiredAPI)&&(a.hasFiredEnded=!0)},isEnded:function(a){return a.hasAPI(this.requiredAPI)?1>=Math.abs(Math.floor(a.el.currentTime*this.floorPrecision)-Math.floor(a.el.duration*this.floorPrecision)):!1}});Media.defineProperties({ended:new Media.Class.Ended});Media.Class.PauseOnOtherPlay=Media.Class.extend({requiredAPI$write:["paused"],constructor:function(){this.listenTo(Media,{created:this.onCreated,play:this.onPlay})},onCreated:function(a){a.defineProperties({pauseonotherplay$enum$write:a.options.pauseonotherplay})},onPlay:function(a){for(var b=0,c=Media.players;b<c;b++){var d=Media.players[b];d.pauseonotherplay&&a.hasAPI("paused")&&d.el.pause()}}});Media.defineProperties({pauseonotherplay:new Media.Class.PauseOnOtherPlay});Media.DefaultOptions.add({pauseonotherplay:!1});Media.Class.Players=Media.Class.List.extend({constructor:function(){List.apply(this,arguments)},findById:function(a){for(var b=0,c=this.length;b<c;b++){var d=this[b];if(d.el&&d.el.id===a)return d}return null},findByElement:function(a){for(var b=0,c=this.length;b<c;b++){var d=this[b];if(d.el&&d.el.id===a)return d}return null}});Media.defineProperties({players$enum$write:new Media.Class.Players});Media.Class.Resize=Media.Class.extend({constructor:function(a){this.listenTo(Media,{created:this.onCreated,"resize change":this.onResize});this.addEventListeners()},addEventListeners$write:function(){window.removeEventListener("resize",this.onWindowResize);window.addEventListener("resize",this.onWindowResize);document.addEventListener("fullscreenchange",this.onFullScreenChanged)},onCreated:function(a){this.triggerMediaResize(a)},onFullScreenChanged$write$bind:function(){delay(this.resizeAllPlayers,
1)},onResize:function(a,b){b.fake||this.resizeAllPlayers()},onWindowResize$write$bind:function(){this.resizeAllPlayers()},resizeAllPlayers$bind:function(){for(var a=0,b=Media.players.length;a<b;a++)this.triggerMediaResize(Media.players[a])},triggerMediaResize:function(a){a.dispatchEvent("resize",this.getDimensions(a));a.dispatchEvent("postresize",this.getDimensions(a))},getDimensions:function(a){a=a.options;return{fullscreen:new Media.Class.Dimensions(a.mediafullscreensize,a.mediafullscreenratio,
...
c;b++)if(this[b].el.id===a)return this[b];return null},destroy:function(){for(var a=0,b=this.length;a<b;a++)this[a].destroy();this.length=0;this.stopListening()}});Media.DOMEvents.add(["addtexttrack","removetexttrack"]);Media.Class.TextTracks=Media.Class.extend({constructor:function(a){this.listenTo(Media,{create:this.onCreate,timeupdate:this.onTimeUpdate,destroy:this.onDestroy})},onCreate:function(a){a.defineProperties({tracks$enum$write:new Media.Class.TextTrackList(a)})},onTimeUpdate:function(a,b){if(!b||b.slow){b=0;for(var c=a.tracks.length;b<c;b++)a.tracks[b].update()}},onChange:function(a){delete a.tracks;this.onCreate(a);this.onTimeUpdate(a)},onDestroy:function(a){a.tracks&&(a.tracks.destroy(),delete a.tracks)}},
null,{instanceEvents:!0});Media.defineProperties({texttracks$write:new Media.Class.TextTracks});Media.Class.TimeUpdate=Media.Class.extend({playing:null,interval:null,slowInterval:null,inRaf:!1,lastTickTime:null,slowLastTickTime:null,mediumLastTickTime:null,constructor:function(){this.playing=[];this.listenTo(Media,{play:this.onPlay,"pause destroyed ended":this.onPause});this.onRaf=this.onRaf.bind(this)},onPlay:function(a){for(var b=0,c=this.playing.length;b<c;b++)if(this.playing[b]===a)return;this.playing.push(a);this.inRaf||(rafer.request(this.onRaf),this.inRaf=!0)},onRaf:function(){var a=
...
destroy:function(){MediaUI.Input.prototype.destroy.apply(this,arguments);this.removeEventListeners();this.$els=this.ui=null}});MediaUI.Input.Skip=MediaUI.Input.extend({floorPrecision:10,ui:null,interactions:null,lastEvent:0,skipped:0,constructor:function(a){MediaUI.Input.apply(this,arguments);this.interactions=[];this.clear=debounce(this.clear.bind(this),500);this.ui=a;this.listenTo(this.ui,{tap:this.onSingleTap,dbltap:this.onDoubleTap})},onSingleTap:function(a){this.ui.options.uiskip&&Media.device.wasUsingTouchRecently&&(this.interactions.length=0)},onDoubleTap$bind:function(a){if(this.ui.options.uiskip&&Media.device.wasUsingTouchRecently&&
...
"attr","aria-label",a);rafer.call(this.$els,"attr","aria-pressed",b?"false":"true")}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.PlayPauseState=MediaUI.Output.extend({floorPrecision:10,ui:null,$els:null,requiredAPI:["paused","currentTime","duration"],constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"playpausestate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"timeupdate play pause ended":this.onUpdate}),this.onUpdate())},onUpdate:function(a){if((!a||"timeupdate"!==a.type||a.slow)&&this.$els.length)if(a=this.ui.options,this.ui.media.hasAPI(this.requiredAPI)){var b=
this.isAtStart(),c=this.isAtEnd(),d=this.ui.media.hasAPI(this.requiredAPI)?this.ui.source.paused:!0;rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-disabled",a),!1);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-playing",a),!d);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-paused",a),d);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-start",a),b);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-end",
a),c);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-middle",a),!c&&!b)}else rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-disabled",a),!0),rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-playing",a),!1),rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-paused",a),!0),rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-start",a),!0),rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-end",
a),!1),rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-middle",a),!1)},isAtStart:function(){var a=this.ui.media.hasAPI(this.requiredAPI)?this.ui.source.currentTime:0;return 1>=Math.floor(a*this.floorPrecision)},isAtEnd:function(){var a=this.ui.media.hasAPI(this.requiredAPI);return 1>=Math.abs(Math.floor((a?this.ui.source.currentTime:0)*this.floorPrecision)-Math.floor((a?this.ui.source.duration:0)*this.floorPrecision))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,
arguments);this.$els=this.ui=null}});MediaUI.Output.Poster=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"poster");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{change:this.onUpdate}),this.onUpdate())},onUpdate$bind:function(){var a=this.ui.source.getAttribute("poster");this.$els.forEach(function(b){switch(b.nodeName){case "IMG":b.src=a;break;default:b.style.backgroundImage="url("+a+")"}}.bind(this))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,
arguments);this.$els=this.ui=null}});MediaUI.Output.PosterState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"posterstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{change:this.onUpdate}),this.onUpdate())},onUpdate:function(a){this.$els.length&&(a=this.ui.options,a.uiallowposter?(rafer.call(this.$els,"toggleClass",replace("${classprefix}posterstate-disabled",a),!1),rafer.call(this.$els,"toggleClass",
replace("${classprefix}posterstate-force",a),a.uialwaysshowposter)):(rafer.call(this.$els,"toggleClass",replace("${classprefix}posterstate-disabled",a),!0),rafer.call(this.$els,"toggleClass",replace("${classprefix}posterstate-force",a),!1)))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});Media.DefaultOptions.add({uialwaysshowposter:!1,uiallowposter:!0});MediaUI.Output.Resize=MediaUI.Output.extend({ui:null,$els:null,$elsinner:null,initial:!0,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"resize");this.$elsinners=a.$all().filterByAttribute(a.options.outputattribute,"resizeinner");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{resize:this.onResize}))},onOptionsChange:function(a,b,c){switch(a){case "mediasize":case "mediaposition":case "mediaratio":case "mediafullscreensize":case "mediafullscreenposition":case "mediafullscreenratio":case "uisize":case "uiposition":case "uiratio":case "uifullscreensize":case "uifullscreenposition":case "uifullscreenratio":this.onResize(Media.resize.getDimensions(this.ui.media))}},
onResize$bind:function(a){var b=this.getUIDimensions(),c=new Media.Class.Dimensions(this.ui.el.offsetParent||window),d=b[this.ui.fullscreen.isActive?"fullscreen":"normal"];"auto"===d.height.unit&&"auto"===d.width.unit&&(d.height.value="contain",d.height.unit="contain",d.width.value="contain",d.width.unit="contain");"cover"===d.height.value&&(d.height.value="fill",d.height.unit="fill",d.width.value="fill",d.width.unit="fill");this.$els.forEach(function(a){var b=this.getStyles(a,this.ui.source,c,d),
e;for(e in b)this.initial?a.style[e]=b[e]:rafer.set(a.style,e,b[e])}.bind(this));b=!!elements(this.ui.source).path().find(function(a){return a===this.ui.el}.bind(this));var e=new Media.Class.Dimensions((b?this.ui.el.offsetParent:this.ui.source.offsetParent)||window),f=a[this.ui.fullscreen.isActive?"fullscreen":"normal"];if(b)switch(d.height.value){case "contain":a="auto"===f.height.unit&&"auto"===f.width.unit;if("fill"===f.height.value||"cover"===f.height.value||a)f.height.value="contain",f.height.unit=
"contain",f.width.value="contain",f.width.unit="contain";break;case "fill":if(a="auto"===f.height.unit&&"auto"===f.width.unit)f.height.value="cover",f.height.unit="cover",f.width.value="cover",f.width.unit="cover";break;case "retain":f.height.value="retain",f.height.unit="retain",f.width.value="retain",f.width.unit="retain"}this.$elsinners.forEach(function(a){var b=this.getStyles(a,this.ui.source,e,f,{usePxValues:!1,transform:Media.device.isIE11?"scale(1.02)":""}),c;for(c in b)this.initial?a.style[c]=
b[c]:rafer.set(a.style,c,b[c])}.bind(this));this.initial=!1},getStyles:function(a,b,c,d,e){e=e||{};e.transform=e.transform||"";a={"object-fit":"fill"};switch(d.width.unit){case "contain":d.ratio<=c.ratio?(a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%",a.width=makeUnit(c.height.value*d.ratio,c.height.unit)):(a.width=e.usePxValues?makeUnit(c.width.value,c.width.unit):"100%",a.height=makeUnit(c.width.value/d.ratio,c.width.unit));break;case "cover":d.ratio<=c.ratio?(a.width=e.usePxValues?
makeUnit(c.width.value,c.width.unit):"100%",a.height=makeUnit(c.width.value/d.ratio,c.width.unit)):(a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%",a.width=makeUnit(c.height.value*d.ratio,c.height.unit));break;case "retain":var f=clamp(0,c.height.value,this.ui.size.height(b));b=clamp(0,c.width.value,this.ui.size.width(b));d.ratio<=c.ratio?(a.height=makeUnit(f,c.height.unit),a.width=makeUnit(f*d.ratio,c.height.unit)):(a.width=makeUnit(b,c.width.unit),a.height=makeUnit(b/d.ratio,
c.width.unit));break;case "fill":a.width=e.usePxValues?makeUnit(c.width.value,c.width.unit):"100%";a.height=e.usePxValues?makeUnit(c.height.value,c.height.unit):"100%";break;case "none":a.height="";a.width="";break;default:"auto"!==d.width.unit&&(a.width=makeUnit(d.width.value,d.width.unit)),"auto"!==d.height.unit&&(a.height=makeUnit(d.height.value,d.height.unit)),"auto"===d.width.unit&&(a.width=makeUnit(c.height.value*d.ratio,"px")),"auto"===d.height.unit&&(a.height=makeUnit(c.width.value/d.ratio,
"px"))}var g=!1;c=!1;b=["0","0"];f=["","","",""];switch(d.x.keyword){case "center":c=g=!0;f[3]="50%";b[0]="-50%";break;case "left":g=!0;f[3]=d.x.value;break;case "right":g=!0,f[1]=d.x.value}switch(d.y.keyword){case "center":c=g=!0;f[0]="50%";b[1]="-50%";break;case "top":g=!0;f[0]=d.y.value;break;case "bottom":g=!0,f[2]=d.y.value}a.position=g?"absolute":"";d=[e.transform];c&&d.unshift("translate("+b.join(",")+")");a.transform=d.length?d.join(" "):"";a.top=f[0];a.right=f[1];a.bottom=f[2];a.left=f[3];
return a},getUIDimensions:function(){var a=this.ui.options;return{fullscreen:new Media.Class.Dimensions(a.uifullscreensize,a.uifullscreenratio,a.uifullscreenposition),normal:new Media.Class.Dimensions(a.uisize,a.uiratio,a.uiposition)}},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.el=this.ui=null}});
