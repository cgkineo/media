(function(root,factory){if(typeof define==='function'&&define.amd){define(function(){return factory(root, root.jQuery);});}else{var module = factory(root, root.jQuery);for(var k in module){root[k]=module[k];}}}(typeof self!=='undefined'?self:this,function(window,$){var exports = {}; var getUrl=function(a,b,c){var e=new XMLHttpRequest;e.addEventListener("load",function(a){b.call(c,a.target.responseText)});e.open("GET",a);e.send()},postUrl=function(a,b,c,e){var d=new XMLHttpRequest;d.addEventListener("load",function(a){c.call(e,a.target.responseText)});d.open("POST",a);d.send(b)};var parseUnit=function(a,b,c){a=String(a||0)+String(b||"");var e=a.match(/[^0-9\.]+/g);b=b||c||"px";e&&(b=e[0]);return{value:parseFloat(a)||0,unit:b}},makeUnit=function(a,b,c){b=b||c||"px";switch(b){case "px":a=Math.round(a,0)}return a+b};var delay=function(a,b){setTimeout(a,b)},debounce=function(a,b){var c=null;return function(){var e=arguments;clearTimeout(c);c=setTimeout(function(){a.apply(this,e)}.bind(this),b||0)}};var toArray=function(a,b){return a?Array.prototype.slice.call(a,b||0):[]},isArray=function(a){return"[object Array]"==Object.prototype.toString.call(a)};var clamp=function(a,b,c){return b<a?a:b>c?c:b},isNumber=function(a){return"[object Number]"==Object.prototype.toString.call(a)};var isObject=function(a){return"[object Object]"==Object.prototype.toString.call(a)},extendNotEnumerable=function(a,b){for(var c=1,e=arguments.length;c<e;c++){var d=arguments[c];if(d){var f=Object.keys(d);c=0;for(e=f.length;c<e;c++){var g=f[c];Object.getOwnPropertyDescriptor(d,g).configurable&&Object.defineProperty(a,g,{configurable:!0,value:d[g],enumerable:!1,writable:!0})}}}return a},extend=function(a,b){a=a||{};for(var c=1,e=arguments.length;c<e;c++){var d=arguments[c],f;for(f in d)a[f]=d[f]}return a},
defaults=function(a,b){a=a||{};for(var c=1,e=arguments.length;c<e;c++){var d=arguments[c],f;for(f in d)a.hasOwnProperty(f)||(a[f]=d[f])}return a};var indexOfRegex=function(a,b,c){a=(c=c||0)?a.substring(c):a;return(b=a.match(b))?a.indexOf(b[0])+c:-1},lastIndexOfRegex=function(a,b,c){a=(c=c||0)?a.substring(0,c):a;return(b=a.match(b))?a.lastIndexOf(b[b.length-1]):-1},includes=function(a,b,c){"number"!==typeof c&&(c=0);return"string"===typeof a&&c+b.length>a.length?!1:-1!==a.indexOf(b,c)},replace=function(a,b,c){c=c||{clean:!0};replace.cache=replace.cache||{};for(var e in b){var d="\\$\\{"+e+"\\}";d=replace.cache[d]=replace.cache[d]||new RegExp("\\$\\{"+
e+"\\}","gi");a=a.replace(d,b[e])}c.clean&&(a=a.replace(/\$\{[^\}]+\}/g,""));return a};var properties=function(a,b){var c=function(a,b){return function(){return this["_"+a]=this["_"+a]||b.bind(this)}},e=!!b;b=b||a;for(var d={},f=Object.getOwnPropertyNames(b),g=0,l=f.length;g<l;g++){var h=f[g],k=h.indexOf("$");if(-1!==k||e){if(-1===k){var m="";k=h}else m=h.slice(k),k=h.slice(0,k);if(k){var n=m.split("$"),q=includes(n,"bind");m=includes(n,"get");var p=includes(n,"set"),r=includes(n,"value"),v=includes(n,"enum"),u=includes(n,"write");n=includes(n,"config");var t=0;t+=m?1:0;t+=p?1:0;t+=
r?1:0;if(1<t)throw"Cannot have two types in one definition.";t+=v?1:0;t+=u?1:0;t+=n?1:0;q?(m=!0,u=!1,q=c(k,b[h])):q=b[h];r=d[k]=d[k]||{value:q};m&&(r.get=q);p&&(r.set=q);v&&(r.enumerable=!0);u&&(r.writable=!0);n&&(r.configurable=!0);r.value&&(r.get||r.set)&&delete r.value;delete b[h];delete a[k]}}}if(!Object.keys(d).length)return a;Object.defineProperties(a,d);return a};var EventsInitialize=function(a){a.events&&a.trigger||(a.events||Object.defineProperty(a,"events",{value:new EventsRegistry,enumerable:!1,writable:!0}),a.trigger||Object.defineProperty(a,"trigger",{value:Events.trigger,enumerable:!1,writable:!0}))},EventsArgumentsNotation=function(a,b,c,e,d){if(a instanceof Object){c=c||d;for(var f in a)for(var g=f.split(" "),l=0,h=g.length;l<h;l++){var k=g[l];e.call(d,k,a[f],c)}}else if("string"===typeof a)for(c=c||d,g=a.split(" "),l=0,h=g.length;l<h;l++)k=g[l],
e.call(d,k,b,c);else if(void 0===a&&void 0===b&&void 0===c)return e.call(d,null,null,null)},EventsRegistry=function(){};EventsRegistry.prototype=[];var EventRegister=function(a){if(a.name){if(!a.callback)throw"Cannot find callback";EventsInitialize(a.from);EventsInitialize(a.to);this.from=a.from;this.to=a.to;this.context=a.context;this.name=a.name;this.callback=a.callback;this.once=a.once;this.from.events.push(this);this.from!==this.to&&this.to.events.push(this)}};
...
var Events={events:null,listenTo:function(a,b,c){EventsArgumentsNotation(b,c,a,function(a,b,c){new EventRegister({from:c,to:this,context:this,name:a,callback:b,once:!1})},this)},listenToOnce:function(a,b,c){EventsArgumentsNotation(b,c,a,function(a,b,c){new EventRegister({from:c,to:this,context:this,name:a,callback:b,once:!0})},this)},stopListening:function(a,b,c){EventsArgumentsNotation(b,c,a,function(a,b,c){if(this.events)for(c=this.events.length-1;-1<c;c--){var e=this.events[c];e.to.events!==this.events||
null!==a&&e.name!==a||null!==b&&e.callback!==b||e.destroy()}},this)},on:function(a,b,c){EventsArgumentsNotation(a,b,c,function(a,b,c){new EventRegister({from:this,to:this,context:c,name:a,callback:b,once:!1})},this)},once:function(a,b,c){EventsArgumentsNotation(a,b,c,function(a,b,c){new EventRegister({from:this,to:this,context:c,name:a,callback:b,once:!0})},this)},off:function(a,b,c){EventsArgumentsNotation(a,b,c,function(a,b,c){if(this.events)for(c=this.events.length-1;-1<c;c--){var e=this.events[c];
e.from.events!==this.events||null!==a&&e.name!==a||null!==b&&e.callback!==b||e.destroy()}},this)},trigger:function(a){EventsInitialize(this);var b=[];if(this.events){for(var c=0,e=this.events.length;c<e;c++){var d=this.events[c];d.from.events!==this.events||"*"!==d.name&&d.name!==a||b.push(d)}b.reverse();for(c=b.length-1;-1<c;c--)d=b[c],"*"===d.name?d.callback.apply(d.context,arguments):d.callback.apply(d.context,toArray(arguments,1)),d.once&&d.destroy()}},destroy:function(){this.stopListening()}};var ClassExtend=function(a,b,c){var e=this;var d=a&&a.hasOwnProperty("constructor")?a.constructor:function(){return e.apply(this,arguments)};Object.defineProperty(d,"classOptions",{value:defaults(c,e.classOptions,{extendFunction:!0,inheritClassEnumerables:!1,classEvents:!1,classProperties:!0,instanceEvents:!1,instanceProperties:!0}),enumerable:!1,writable:!0});d.prototype=Object.create(e.prototype);d.classOptions.extendFunction&&extendNotEnumerable(d,{extend:ClassExtend});d.classOptions.classEvents&&
extendNotEnumerable(d,Events);d.classOptions.inheritClassEnumerables&&extend(d,e);extend(d,b);d.classOptions.instanceEvents&&void 0===d.prototype.events&&extendNotEnumerable(d.prototype,Events);extend(d.prototype,a);d.classOptions.instanceProperties&&(Object.defineProperty(d.prototype,"defineProperties",{value:function(a){return properties(this,a)},enumerable:!1,writable:!1,configurable:!1}),properties(d.prototype));d.classOptions.classProperties&&(Object.defineProperty(d,"defineProperties",{value:function(a){return properties(this,
a)},enumerable:!1,writable:!1,configurable:!1}),properties(d));extendNotEnumerable(d.prototype,{constructor:d});return d},ClassParent=function(a,b){},ListParent=function(a,b){};ListParent.prototype=[];var Class=ClassExtend.call(ClassParent,{constructor:function(){}},{},{classEvents:!1,instanceEvents:!1}),List=ClassExtend.call(ListParent,{constructor:function(){}},{},{classEvents:!1,instanceEvents:!1});
...
b=0,c=a.length;b<c;b++)this.push(a[b]);return this},clone:function(a){for(var b=[],c=0,e=this.length;c<e;c++)this[c].cloneNode&&b.push(this[c].cloneNode(a));return new Elements(b,this.subject)},on:function(a,b,c){c=c||{};c.passive=!1!==c.passive?!0:c.passive;if(a instanceof Object){for(var e in a)this.on(e,a[e],b);return this}this.forEach(function(e){e.addEventListener&&e.addEventListener(a,b,c)});return this},off:function(a,b){if(a instanceof Object){for(var c in a)this.off(c,a[c]);return this}this.forEach(function(c){c.removeEventListener&&
...
"")});return this},attrs:function(a){if(a)return this.attr(a);a={};for(var b=0,c=this[0].attributes.length;b<c;b++)a[this[0].attributes[b].name]=this[0].attributes[b].value;return a},attr:function(a,b){if(a instanceof Object){for(var c in a)this.attr(c,a[c]);return this}this.forEach(function(c){c.setAttribute&&c.setAttribute(a,b)});return this},toggleClass:function(a,b){this.forEach(function(c){switch(typeof a){case "string":a=a.split(" ")}b=void 0===b?!0:b;for(var e=c.classList,d=0,f=a.length;d<
f;d++){for(var g=a[d],l=!1,h=0,k=e.length;h<k;h++)e[h]===g&&(l=!0);!l&&b?e.add(g):l&&!b&&e.remove(g)}c.classList.length||elements(c).removeAttribute("class")});return this},html:function(a){if(void 0===a)return this[0]&&this[0].innerHTML;this.forEach(function(b){b.innerHTML=a})},dispatchEvent:function(a,b){var c=this[0];b=defaults(b,{bubbles:!1,cancelable:!0});if(!Elements._ie11)try{var e=new Event(a,b);extend(e,b);c.dispatchEvent(e);return this}catch(d){Elements._ie11=!0}if(Elements._ie11)return e=
document.createEvent("Event"),e.initEvent(a,b.bubbles,b.cancelable),extend(e,b),c.dispatchEvent(e),this}}),elements=function(a,b){return new Elements(a,b)};extend(elements,Elements);var Rafer=Class.extend({deferred:null,requests:null,isWaiting:!1,mode:"ram",ramLimit:50,currentDeferredLength:0,currentRequestsLength:0,constructor:function(){this.defineProperties({deferred$write:Array(100),requests$write:Array(100),currentDeferredLength$write:0,currentRequestsLength$write:0,isWaiting$write:!1})},resizeDeferred$write:function(){this.deferred.length*=2},resizeRequests$write:function(){this.requests.length*=2},set:function(a,b,c){this.isWaiting||this.request(this.dummy);this.currentDeferredLength===
this.deferred.length-1&&this.resizeDeferred();this.deferred[this.currentDeferredLength]={subject:a,name:b,value:c,type:"set"};this.currentDeferredLength++},get:function(a,b){for(var c=0,e=this.currentDeferredLength;c<e;c++){var d=this.deferred[c];if(d.subject===a&&d.name===b)return d.value}return a[b]},call:function(a,b,c){this.isWaiting||this.request(this.dummy);this.currentDeferredLength===this.deferred.length-1&&this.resizeDeferred();var e={order:0,subject:a,name:b,value:toArray(arguments,2),type:"call"};
this.deferred[this.currentDeferredLength]=e;this.currentDeferredLength++},callLast:function(a,b,c){this.isWaiting||this.request(this.dummy);this.currentDeferredLength===this.deferred.length-1&&this.resizeDeferred();var e={order:1,subject:a,name:b,value:toArray(arguments,2),type:"call"};this.deferred[this.currentDeferredLength]=e;this.currentDeferredLength++},dummy$write:function(){},flush$write:function(){var a=0;do{for(var b=[],c=this.currentDeferredLength,e=0,d=c;e<d;e++)b.push(this.deferred[e]),
this.deferred[e]=null;b.sort(function(a,b){return b.order-a.order});e=this.currentDeferredLength=0;for(d=c;e<d;e++){c=b[e];try{switch(c.type){case "set":c.subject[c.name]=c.value;break;case "call":c.name||"function"!==typeof c.subject?c.subject||"function"!==typeof c.name?c.subject[c.name].apply(c.subject,c.value):c.name.apply(c.subject,c.value):c.subject.apply(c.name,c.value)}}catch(f){debugger}}this.currentDeferredLength&&a++}while("ram"===this.mode&&0!==this.currentDeferredLength&&a<this.ramLimit);
...
k(Element.prototype,"requestFullscreen");k(document,"fullscreenEnabled");k(document,"onfullscreenchange");k(document,"onfullscreenerror");(function(){if(!g){g=!0;for(var a=function(a){a=c(e("fullscreenchange"),a);document.dispatchEvent(a)},b=function(a){a=c(e("fullscreenerror"),a);document.dispatchEvent(a)},d=0,h=f.onfullscreenchange.length;d<h;d++)void 0!==document[f.onfullscreenchange[d]]&&(document[f.onfullscreenchange[d]]=a);d=0;for(h=f.onfullscreenerror.length;d<h;d++)void 0!==document[f.onfullscreenerror[d]]&&
(document[f.onfullscreenerror[d]]=b)}})();(function(){p.fullscreenElement||(p.fullscreenElement=!0,Object.defineProperty(document,"fullscreenElement",{get:function(){if(m)return b&&console.log("get fullscreenElement",n),n;b&&console.log("get fullscreenElement",document[d.fullscreenElement]);return document[d.fullscreenElement]}}))})();(function(){p.fullscreenEnabled||(p.fullscreenEnabled=!0,Object.defineProperty(document,"fullscreenEnabled",{get:function(){if(m)return b&&console.log("get fullscreenEnabled",
!0),!0;b&&console.log("get fullscreenEnabled",document[d.fullscreenEnabled]);return document[d.fullscreenEnabled]}}))})();(function(){p.exitFullscreen||(p.exitFullscreen=!0,document.exitFullscreen=function(){b&&console.log("exitFullscreen");if(m)n=null,document.dispatchEvent(e("fullscreenchange"));else return document[d.exitFullscreen].apply(this,arguments)})})();(function(){p.requestFullscreen||(p.requestFullscreen=!0,Element.prototype.requestFullscreen=function(){q=!0;b&&console.log("requestFullscreen",
this);if(m)n=this,document.dispatchEvent(e("fullscreenchange"));else return this[d.requestFullscreen].apply(this,arguments)})})();(function(){p.onfullscreenchange||(p.onfullscreenchange=!0,Object.defineProperty(document,"onfullscreenchange",{get:function(){b&&console.log("get onfullscreenchange",document[d.onfullscreenchange]);return document[d.onfullscreenchange]},set:function(a){b&&console.log("set onfullscreenchange",document[d.onfullscreenchange]);document[d.onfullscreenchange]=a}}))})();(function(){p.onfullscreenerror||
(p.onfullscreenerror=!0,Object.defineProperty(document,"onfullscreenerror",{get:function(){b&&console.log("get onfullscreenerror",document[d.onfullscreenerror]);return document[d.onfullscreenerror]},set:function(a){b&&console.log("set onfullscreenerror",document[d.onfullscreenerror]);document[d.onfullscreenerror]=a}}))})();window.removeEventListener("keyup",a);window.addEventListener("keyup",a);m=!document.fullscreenEnabled;window.fullscreenPolyfill={};Object.defineProperties(window.fullscreenPolyfill,
{useFullWindow:{get:function(){return m},set:function(a){m=a},enumerable:!0},api:{get:function(){return d},enumerable:!0},applied:{get:function(){return p},enumerable:!0},debug:{get:function(){return b},set:function(a){b=a}}});h?l?console.log("Fullscreen API (from perfect API)."):console.log("Fullscreen API (from partially implemented API)."):console.log("Fullscreen API (from broken API).")}})();var MediaUI=Class.extend({media$write:null,options$write:null,source$write:null,$source$write:null,el$write:null,$el$write:null,inputs:null,outputs:null,constructor:function MediaUI(a,b){if(!b.uienabled)return this.destroy();this.media=a;this.media.ui=this.media.ui||new MediaUIList;this.media.ui.add(this);this.options=b||{};this.options instanceof Media.DefaultOptions||(this.options=new Media.DefaultOptions(b));this.options.add({ui:this});this.source=a.el;this.$source=elements(a.el);this.inputs={};
...
Math.abs(Math.floor(a.el.currentTime*this.floorPrecision)-Math.floor(a.el.duration*this.floorPrecision))}});Media.defineProperties({ended:new Media.Class.Ended});Media.Class.PauseOnPlay=Media.Class.extend({constructor:function(){this.listenTo(Media,{created:this.onCreated,play:this.onPlay})},onCreated:function(a){a.defineProperties({pauseonplay$enum$write:a.options.pauseonplay})},onPlay:function(a){a=0;for(var b=Media.players;a<b;a++){var c=Media.players[a];c.pauseonplay&&c.el.pause()}}});Media.defineProperties({pauseonplay:new Media.Class.PauseOnPlay});Media.DefaultOptions.add({pauseonplay:!1});Media.Class.Players=Media.Class.List.extend({constructor:function(){List.apply(this,arguments)},findById:function(a){for(var b=0,c=this.length;b<c;b++){var e=this[b];if(e.el&&e.el.id===a)return e}return null},findByElement:function(a){for(var b=0,c=this.length;b<c;b++){var e=this[b];if(e.el&&e.el.id===a)return e}return null}});Media.defineProperties({players$enum$write:new Media.Class.Players});Media.Class.Resize=Media.Class.extend({constructor:function(a){this.listenTo(Media,{created:this.onCreated,resize:this.onResize});this.addEventListeners()},addEventListeners$write:function(){window.removeEventListener("resize",this.onWindowResize);window.addEventListener("resize",this.onWindowResize);document.addEventListener("fullscreenchange",this.onFullScreenChanged)},onCreated:function(a){this.triggerMediaResize(a)},onFullScreenChanged$write$bind:function(){delay(this.resizeAllPlayers,1)},onResize:function(a,
b){b.fake||this.resizeAllPlayers()},onWindowResize$write$bind:function(){this.resizeAllPlayers()},resizeAllPlayers$bind:function(){for(var a=0,b=Media.players.length;a<b;a++)this.triggerMediaResize(Media.players[a])},triggerMediaResize:function(a){var b=a.options;a.dispatchEvent("resize",{fullscreen:new Media.Class.Dimensions(b.mediafullscreensize,b.mediafullscreenratio,b.mediafullscreenposition),normal:new Media.Class.Dimensions(b.mediasize,b.mediaratio,b.mediaposition)});a.dispatchEvent("postresize",
...
-1<a.indexOf("\r\n")?"\r\n":"\n";a=a.split(b);b=[];for(var c=[],e=0,d=a.length;e<d;e++){var f=a[e],g=e===a.length-1,l=!f;g&&!l&&c.push(f);if((g||l)&&c.length){if(-1<c[0].toLowerCase().indexOf("webvtt")&&(c.splice(0,1),!c.length))continue;b.push({title:null,lines:c});c=[]}else l||c.push(f)}try{for(e=0,d=b.length;e<d;e++)if(c=b[e],0!==c.lines[0].indexOf("NOTE"))if(0===c.lines[0].indexOf("STYLE"))console.log("Media does not support STYLE lines in WebVTT yet. Please leave an issue if needed.");else{-1===
...
parseTimePlacement$write:function(a){a=a.trim();var b=indexOfRegex(a,/--\x3e/);if(-1===b)throw"Time declaration error, no --\x3e";var c=a.slice(0,b).trim();a=a.slice(b);b=indexOfRegex(a,/[0-9]+/);if(-1===b)throw"Time declaration error, no end time";a=a.slice(b);b=indexOfRegex(a,/[ ]{1}/);-1===b&&(b=a.length);var e=a.slice(0,b).trim();a=a.slice(b);return extend({startTime:this.parseTime(c),endTime:this.parseTime(e)},this.parsePlacement(a))},timeUnits$write:[.001,1,60,360],parseTime$write:function(a){a=
a.split(/[:\.,]{1}/g).reverse();if(3>a.length)throw"Time declaration error, mm:ss.ttt or hh:mm:ss.tt";for(var b=0,c=0,e=a.length;c<e;c++)b+=this.timeUnits[c]*parseInt(a[c]);return b},parsePlacement$write:function(a){var b={line:-1,position:"50%",size:"100%",align:"middle"};a.split(" ").filter(function(a){return a}).forEach(function(a){var c=a.split(":");a=c[1].split(",");c=c[0].toLowerCase();switch(c){case "d":c="vertical";break;case "l":c="line";break;case "t":c="position";break;case "s":c="size";
...
b,c){this.id="cue-"+ ++Media.Class.TextTrackCue.id;this.startTime=a;this.endTime=b;this.text=c;this.defineProperties({_isLive$write:!1,track$write:!1})},getCueAsHTML:function(){var a=this.track.media.options.classprefix,b=document.createElement("span"),c={id:this.id,lang:this.track.language,class:a+"cue",style:""};this.renderCuePlacement(c,this);for(var e in c)b.setAttribute(e,c[e]);c=document.createElement("span");c.setAttribute("class",a+"cue-text");c.innerHTML='<span class="'+a+'cue-line">'+this.text.replace(/\n/g,
'</span><br><span class="'+a+'cue-line">')+"</span>";b.appendChild(c);return b},renderCuePlacement$write:function(a,b){var c=this.track.media.options.classprefix,e=a["class"].split(" ");e.push(c+"cue-"+b.vertical);var d="position: absolute;";switch(b.vertical){case "horizontal":d+="transform: translateX(-50%);";switch(b.lineAlign){case "start":d+="text-align: left;";e.push(c+"cue-align-left");break;case "middle":d+="text-align: center;";e.push(c+"cue-align-center");break;case "end":d+="text-align: right;",
e.push(c+"cue-align-right")}d+="width:"+b.size+";";d+="left:"+b.position+";";d=(c=-1<String(b.line).indexOf("%"))||0<=b.line?d+("top:"+b.line+"%"):d+("bottom:"+(100-100*Math.abs(b.line))+"%");break;case "rl":d+="transform: translateY(-50%);";switch(b.lineAlign){case "start":d+="text-align: left;";e.push(c+"cue-align-top");break;case "middle":d+="text-align: center;";e.push(c+"cue-align-middle");break;case "end":d+="text-align: right;",e.push(c+"cue-align-bottom")}d+="height:"+b.size+";";d+="top:"+
b.position+";";d=(c=-1<String(b.line).indexOf("%"))||0<=b.line?d+("left:"+b.line+"%"):d+("right:"+(100-100*Math.abs(b.line))+"%");break;case "lr":d+="transform: translateY(-50%);";switch(b.lineAlign){case "start":d+="text-align: left;";e.push(c+"cue-align-top");break;case "middle":d+="text-align: center;";e.push(c+"cue-align-middle");break;case "end":d+="text-align: right;",e.push(c+"cue-align-bottom")}d+="height:"+b.size+";";d+="top:"+b.position+";";(c=-1<String(b.line).indexOf("%"))||0<=b.line?
d+="right:"+b.line+"%":(b=100-100*Math.abs(b.line),d+="left:"+b+"%")}a["class"]=e.join(" ");a.style=d;return a},destroy:function(){this.media=null}},{id:0});Media.DOMEvents.add(["cueenter","cueexit"]);Media.Class.TextTrackList=Media.Class.List.extend({media$write:null,constructor:function(a){this.defineProperties({media$write:a});this.fetch()},default$get:function(){return this.find(function(a){return a.default})},fetch$write:function(){this.destroy();var a={},b=this.media.el.querySelectorAll("track[type='text/vtt']");toArray(b).forEach(function(b){var c=b.getAttribute("srclang"),e=b.getAttribute("src");c&&e&&!a[c]&&(a[c]=new Media.Class.TextTrack(this.media,b))},this);b=[];for(var c in a)b.push(a[c]);
...
e=this.ui.source.paused;rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-playing",a),!e);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-paused",a),e);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-start",a),b);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-end",a),c);rafer.call(this.$els,"toggleClass",replace("${classprefix}playpausestate-middle",a),!c&&!b)}},isAtStart:function(){return 1>=Math.floor(this.ui.source.currentTime*
this.floorPrecision)},isAtEnd:function(){return 1>=Math.abs(Math.floor(this.ui.source.currentTime*this.floorPrecision)-Math.floor(this.ui.source.duration*this.floorPrecision))},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,arguments);this.$els=this.ui=null}});MediaUI.Output.Resize=MediaUI.Output.extend({ui:null,$els:null,$elsinner:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"resize");this.$elsinners=a.$all().filterByAttribute(a.options.outputattribute,"resizeinner");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{resize:this.onResize}))},onResize$bind:function(a){this.resize();this.resizeinner()},resize:function(){this.$els.forEach(function(a){var b=this.getUIDimensions(),
c=new Media.Class.Dimensions(this.ui.el.offsetParent||window);b=this.getStyles(a,c,b[this.ui.fullscreen.isActive?"fullscreen":"normal"]);for(var e in b)rafer.set(a.style,e,b[e])}.bind(this))},resizeinner:function(){this.$elsinners.forEach(function(a){var b=elements(this.ui.source).path().find(function(a){return a===this.ui.el}.bind(this))?this.ui.el.offsetParent:this.ui.source.offsetParent;b=new Media.Class.Dimensions(b||window);b=this.getStyles(a,b,event[this.ui.fullscreen.isActive?"fullscreen":
"normal"],{transform:Media.device.isIE11?"scale(1.02)":""});for(var c in b)rafer.set(a.style,c,b[c])}.bind(this))},getStyles:function(a,b,c,e){e=e||{};e.transform=e.transform||"";var d={"object-fit":"fill"};switch(c.width.unit){case "contain":c.ratio<=b.ratio?(d.height="100%",d.width=makeUnit(b.height.value*c.ratio,b.height.unit)):(d.width="100%",d.height=makeUnit(b.width.value/c.ratio,b.width.unit));break;case "cover":c.ratio<=b.ratio?(d.width="100%",d.height=makeUnit(b.width.value/c.ratio,b.width.unit)):
(d.height="100%",d.width=makeUnit(b.height.value*c.ratio,b.height.unit));break;case "retain":var f=clamp(0,b.height.value,a.videoHeight||a.originalHeight||a.height);a=clamp(0,b.width.value,a.videoWidth||a.originalWidth||a.width);c.ratio<=b.ratio?(d.height="100%",d.width=makeUnit(f*c.ratio,b.height.unit)):(d.width="100%",d.height=makeUnit(a/c.ratio,b.width.unit));break;case "fill":d.height="100%";d.width="100%";break;case "none":d.height="";d.width="";break;default:"auto"!==c.width.unit&&(d.width=
makeUnit(c.width.value,c.width.unit)),"auto"!==c.height.unit&&(d.height=makeUnit(c.height.value,c.height.unit)),"auto"===c.width.unit&&(d.width=makeUnit(b.height.value*c.ratio,"px")),"auto"===c.height.unit&&(d.height=makeUnit(b.width.value/c.ratio,"px"))}var g=!1;b=!1;f=["0","0"];a=["","","",""];switch(c.x.keyword){case "center":b=g=!0;a[3]="50%";f[0]="-50%";break;case "left":g=!0;a[3]=c.x.value;break;case "right":g=!0,a[1]=c.x.value}switch(c.y.keyword){case "center":b=g=!0;a[0]="50%";f[1]="-50%";
break;case "top":g=!0;a[0]=c.y.value;break;case "bottom":g=!0,a[2]=c.y.value}d.position=g?"absolute":"";c=[e.transform];b&&c.unshift("translate("+f.join(",")+")");d.transform=c.length?c.join(" "):"";d.top=a[0];d.right=a[1];d.bottom=a[2];d.left=a[3];return d},getUIDimensions:function(){var a=this.ui.options;return{fullscreen:new Media.Class.Dimensions(a.uifullscreensize,a.uifullscreenratio,a.uifullscreenposition),normal:new Media.Class.Dimensions(a.uisize,a.uiratio,a.uiposition)}},destroy:function(){MediaUI.Output.prototype.destroy.apply(this,
