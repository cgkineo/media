...
Media.DefaultOptions.add({uisize:function(){return this.mediasize},uiratio:function(){return this.mediaratio},uiposition:"none none",uifullscreensize:function(){return this.uisize},uifullscreenratio:function(){return this.uiratio},uifullscreenposition:function(){return this.uiposition}});MediaUI.Output.WaitingState=MediaUI.Output.extend({ui:null,$els:null,constructor:function(a){MediaUI.Output.apply(this,arguments);this.$els=a.$all().filterByAttribute(a.options.outputattribute,"waitingstate");this.$els.length&&(this.ui=a,this.listenTo(this.ui.media,{"loadstart seeking waiting stalled error":this.onWaiting,"canplay seeked playing timeupdate":this.offWaiting}))},onWaiting:function(){this.$els.forEach(function(a){a=elements(a);rafer.call(a,"toggleClass",replace("${classprefix}waitingstate-active",
